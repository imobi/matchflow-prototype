...
<ul class="no-bullet">
  ...
  <ul class="no-bullet">
    <li><a name="toc-adelay" href="#adelay">6.1 adelay</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples" href="#Examples">6.1.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aecho" href="#aecho">6.2 aecho</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-1" href="#Examples-1">6.2.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aeval" href="#aeval">6.3 aeval</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-2" href="#Examples-2">6.3.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-afade" href="#afade">6.4 afade</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-3" href="#Examples-3">6.4.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aformat-1" href="#aformat-1">6.5 aformat</a></li>
    <li><a name="toc-allpass" href="#allpass">6.6 allpass</a></li>
    <li><a name="toc-amerge" href="#amerge">6.7 amerge</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-4" href="#Examples-4">6.7.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-amix" href="#amix">6.8 amix</a></li>
    <li><a name="toc-anull" href="#anull">6.9 anull</a></li>
    <li><a name="toc-apad" href="#apad">6.10 apad</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-5" href="#Examples-5">6.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aphaser" href="#aphaser">6.11 aphaser</a></li>
    <li><a name="toc-aresample-1" href="#aresample-1">6.12 aresample</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-6" href="#Examples-6">6.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-asetnsamples" href="#asetnsamples">6.13 asetnsamples</a></li>
    <li><a name="toc-asetrate" href="#asetrate">6.14 asetrate</a></li>
    <li><a name="toc-ashowinfo" href="#ashowinfo">6.15 ashowinfo</a></li>
    <li><a name="toc-astats-1" href="#astats-1">6.16 astats</a></li>
    <li><a name="toc-astreamsync" href="#astreamsync">6.17 astreamsync</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-7" href="#Examples-7">6.17.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-asyncts" href="#asyncts">6.18 asyncts</a></li>
    <li><a name="toc-atempo" href="#atempo">6.19 atempo</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-8" href="#Examples-8">6.19.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-atrim" href="#atrim">6.20 atrim</a></li>
    <li><a name="toc-bandpass" href="#bandpass">6.21 bandpass</a></li>
    <li><a name="toc-bandreject" href="#bandreject">6.22 bandreject</a></li>
    <li><a name="toc-bass" href="#bass">6.23 bass</a></li>
    <li><a name="toc-biquad" href="#biquad">6.24 biquad</a></li>
    <li><a name="toc-bs2b" href="#bs2b">6.25 bs2b</a></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-9" href="#Examples-9">6.28.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-dcshift" href="#dcshift">6.29 dcshift</a></li>
    <li><a name="toc-earwax" href="#earwax">6.30 earwax</a></li>
    <li><a name="toc-equalizer" href="#equalizer">6.31 equalizer</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-10" href="#Examples-10">6.31.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-flanger" href="#flanger">6.32 flanger</a></li>
    <li><a name="toc-highpass" href="#highpass">6.33 highpass</a></li>
    <li><a name="toc-join" href="#join">6.34 join</a></li>
    <li><a name="toc-ladspa" href="#ladspa">6.35 ladspa</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-11" href="#Examples-11">6.35.1 Examples</a></li>
      <li><a name="toc-Commands" href="#Commands">6.35.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-lowpass" href="#lowpass">6.36 lowpass</a></li>
    <li><a name="toc-pan" href="#pan">6.37 pan</a>
    <ul class="no-bullet">
      <li><a name="toc-Mixing-examples" href="#Mixing-examples">6.37.1 Mixing examples</a></li>
      <li><a name="toc-Remapping-examples" href="#Remapping-examples">6.37.2 Remapping examples</a></li>
    </ul></li>
    <li><a name="toc-replaygain" href="#replaygain">6.38 replaygain</a></li>
    <li><a name="toc-resample" href="#resample">6.39 resample</a></li>
    <li><a name="toc-silencedetect" href="#silencedetect">6.40 silencedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-12" href="#Examples-12">6.40.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-silenceremove" href="#silenceremove">6.41 silenceremove</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-13" href="#Examples-13">6.41.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-treble" href="#treble">6.42 treble</a></li>
    <li><a name="toc-volume" href="#volume">6.43 volume</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-1" href="#Commands-1">6.43.1 Commands</a></li>
      <li><a name="toc-Examples-14" href="#Examples-14">6.43.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-volumedetect" href="#volumedetect">6.44 volumedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-15" href="#Examples-15">6.44.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-17" href="#Examples-17">7.2.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-anullsrc" href="#anullsrc">7.3 anullsrc</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-18" href="#Examples-18">7.3.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-flite" href="#flite">7.4 flite</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-19" href="#Examples-19">7.4.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-sine" href="#sine">7.5 sine</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-20" href="#Examples-20">7.5.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-blend_002c-tblend" href="#blend_002c-tblend">9.7 blend, tblend</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-21" href="#Examples-21">9.7.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-boxblur" href="#boxblur">9.8 boxblur</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-22" href="#Examples-22">9.8.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-codecview" href="#codecview">9.9 codecview</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-23" href="#Examples-23">9.9.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorbalance" href="#colorbalance">9.10 colorbalance</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-24" href="#Examples-24">9.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorlevels" href="#colorlevels">9.11 colorlevels</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-25" href="#Examples-25">9.11.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorchannelmixer" href="#colorchannelmixer">9.12 colorchannelmixer</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-26" href="#Examples-26">9.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colormatrix" href="#colormatrix">9.13 colormatrix</a></li>
    <li><a name="toc-copy" href="#copy">9.14 copy</a></li>
    <li><a name="toc-crop" href="#crop">9.15 crop</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-27" href="#Examples-27">9.15.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-cropdetect" href="#cropdetect">9.16 cropdetect</a></li>
    <li><a name="toc-curves-1" href="#curves-1">9.17 curves</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-28" href="#Examples-28">9.17.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-dctdnoiz" href="#dctdnoiz">9.18 dctdnoiz</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-29" href="#Examples-29">9.18.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-decimate-1" href="#decimate-1">9.19 decimate</a></li>
    <li><a name="toc-dejudder" href="#dejudder">9.20 dejudder</a></li>
    <li><a name="toc-delogo" href="#delogo">9.21 delogo</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-30" href="#Examples-30">9.21.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-deshake" href="#deshake">9.22 deshake</a></li>
    <li><a name="toc-drawbox" href="#drawbox">9.23 drawbox</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-31" href="#Examples-31">9.23.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-drawgrid" href="#drawgrid">9.24 drawgrid</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-32" href="#Examples-32">9.24.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-drawtext-1" href="#drawtext-1">9.25 drawtext</a>
    <ul class="no-bullet">
      <li><a name="toc-Syntax" href="#Syntax">9.25.1 Syntax</a></li>
      <li><a name="toc-Text-expansion" href="#Text-expansion">9.25.2 Text expansion</a></li>
      <li><a name="toc-Examples-33" href="#Examples-33">9.25.3 Examples</a></li>
    </ul></li>
    <li><a name="toc-edgedetect" href="#edgedetect">9.26 edgedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-34" href="#Examples-34">9.26.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-eq" href="#eq">9.27 eq</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-2" href="#Commands-2">9.27.1 Commands</a></li>
    </ul></li>
    <li><a name="toc-extractplanes" href="#extractplanes">9.28 extractplanes</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-35" href="#Examples-35">9.28.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-elbg" href="#elbg">9.29 elbg</a></li>
    <li><a name="toc-fade" href="#fade">9.30 fade</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-36" href="#Examples-36">9.30.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fftfilt" href="#fftfilt">9.31 fftfilt</a></li>
    <li><a name="toc-field" href="#field">9.32 field</a></li>
    <li><a name="toc-fieldmatch" href="#fieldmatch">9.33 fieldmatch</a>
    <ul class="no-bullet">
      <li><a name="toc-p_002fc_002fn_002fu_002fb-meaning-1" href="#p_002fc_002fn_002fu_002fb-meaning-1">9.33.1 p/c/n/u/b meaning</a>
      <ul class="no-bullet">
        <li><a name="toc-p_002fc_002fn" href="#p_002fc_002fn">9.33.1.1 p/c/n</a></li>
        <li><a name="toc-u_002fb" href="#u_002fb">9.33.1.2 u/b</a></li>
      </ul></li>
      <li><a name="toc-Examples-37" href="#Examples-37">9.33.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-fieldorder" href="#fieldorder">9.34 fieldorder</a></li>
    <li><a name="toc-fifo" href="#fifo">9.35 fifo</a></li>
    <li><a name="toc-format-1" href="#format-1">9.36 format</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-38" href="#Examples-38">9.36.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fps-1" href="#fps-1">9.37 fps</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-39" href="#Examples-39">9.37.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-framepack" href="#framepack">9.38 framepack</a></li>
    <li><a name="toc-framestep" href="#framestep">9.39 framestep</a></li>
    <li><a name="toc-frei0r-1" href="#frei0r-1">9.40 frei0r</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-40" href="#Examples-40">9.40.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fspp" href="#fspp">9.41 fspp</a></li>
    <li><a name="toc-geq" href="#geq">9.42 geq</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-41" href="#Examples-41">9.42.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-gradfun" href="#gradfun">9.43 gradfun</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-42" href="#Examples-42">9.43.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-haldclut-1" href="#haldclut-1">9.44 haldclut</a>
    <ul class="no-bullet">
      <li><a name="toc-Workflow-examples" href="#Workflow-examples">9.44.1 Workflow examples</a>
      <ul class="no-bullet">
        <li><a name="toc-Hald-CLUT-video-stream" href="#Hald-CLUT-video-stream">9.44.1.1 Hald CLUT video stream</a></li>
        <li><a name="toc-Hald-CLUT-with-preview" href="#Hald-CLUT-with-preview">9.44.1.2 Hald CLUT with preview</a></li>
      </ul></li>
    </ul></li>
    <li><a name="toc-hflip" href="#hflip">9.45 hflip</a></li>
    <li><a name="toc-histeq" href="#histeq">9.46 histeq</a></li>
    <li><a name="toc-histogram" href="#histogram">9.47 histogram</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-43" href="#Examples-43">9.47.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-hqdn3d-1" href="#hqdn3d-1">9.48 hqdn3d</a></li>
    <li><a name="toc-hqx" href="#hqx">9.49 hqx</a></li>
    <li><a name="toc-hue" href="#hue">9.50 hue</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-44" href="#Examples-44">9.50.1 Examples</a></li>
      <li><a name="toc-Commands-3" href="#Commands-3">9.50.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-idet" href="#idet">9.51 idet</a></li>
    <li><a name="toc-il" href="#il">9.52 il</a></li>
    <li><a name="toc-interlace" href="#interlace">9.53 interlace</a></li>
    <li><a name="toc-kerndeint" href="#kerndeint">9.54 kerndeint</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-45" href="#Examples-45">9.54.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-lenscorrection" href="#lenscorrection">9.55 lenscorrection</a>
    <ul class="no-bullet">
      <li><a name="toc-Options" href="#Options">9.55.1 Options</a></li>
    </ul></li>
    <li><a name="toc-lut3d-1" href="#lut3d-1">9.56 lut3d</a></li>
    <li><a name="toc-lut_002c-lutrgb_002c-lutyuv" href="#lut_002c-lutrgb_002c-lutyuv">9.57 lut, lutrgb, lutyuv</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-46" href="#Examples-46">9.57.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-mergeplanes" href="#mergeplanes">9.58 mergeplanes</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-47" href="#Examples-47">9.58.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-mcdeint" href="#mcdeint">9.59 mcdeint</a></li>
    <li><a name="toc-mpdecimate" href="#mpdecimate">9.60 mpdecimate</a></li>
    <li><a name="toc-negate" href="#negate">9.61 negate</a></li>
    <li><a name="toc-noformat" href="#noformat">9.62 noformat</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-48" href="#Examples-48">9.62.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-noise" href="#noise">9.63 noise</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-49" href="#Examples-49">9.63.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-null" href="#null">9.64 null</a></li>
    <li><a name="toc-ocv" href="#ocv">9.65 ocv</a>
    <ul class="no-bullet">
      <li><a name="toc-dilate-1" href="#dilate-1">9.65.1 dilate</a></li>
      <li><a name="toc-erode" href="#erode">9.65.2 erode</a></li>
      <li><a name="toc-smooth" href="#smooth">9.65.3 smooth</a></li>
    </ul></li>
    <li><a name="toc-overlay-1" href="#overlay-1">9.66 overlay</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-4" href="#Commands-4">9.66.1 Commands</a></li>
      <li><a name="toc-Examples-50" href="#Examples-50">9.66.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-owdenoise" href="#owdenoise">9.67 owdenoise</a></li>
    <li><a name="toc-pad" href="#pad">9.68 pad</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-51" href="#Examples-51">9.68.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-palettegen-1" href="#palettegen-1">9.69 palettegen</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-52" href="#Examples-52">9.69.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-paletteuse" href="#paletteuse">9.70 paletteuse</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-53" href="#Examples-53">9.70.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-perspective" href="#perspective">9.71 perspective</a></li>
    <li><a name="toc-phase" href="#phase">9.72 phase</a></li>
    <li><a name="toc-pixdesctest" href="#pixdesctest">9.73 pixdesctest</a></li>
    <li><a name="toc-pp" href="#pp">9.74 pp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-54" href="#Examples-54">9.74.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-pp7" href="#pp7">9.75 pp7</a></li>
    <li><a name="toc-psnr" href="#psnr">9.76 psnr</a></li>
    <li><a name="toc-pullup-1" href="#pullup-1">9.77 pullup</a></li>
    <li><a name="toc-qp" href="#qp">9.78 qp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-55" href="#Examples-55">9.78.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-removelogo" href="#removelogo">9.79 removelogo</a></li>
    <li><a name="toc-repeatfields" href="#repeatfields">9.80 repeatfields</a></li>
    <li><a name="toc-rotate" href="#rotate">9.81 rotate</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-56" href="#Examples-56">9.81.1 Examples</a></li>
      <li><a name="toc-Commands-5" href="#Commands-5">9.81.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-sab" href="#sab">9.82 sab</a></li>
    <li><a name="toc-scale-1" href="#scale-1">9.83 scale</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-1" href="#Options-1">9.83.1 Options</a></li>
      <li><a name="toc-Examples-57" href="#Examples-57">9.83.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-separatefields" href="#separatefields">9.84 separatefields</a></li>
    <li><a name="toc-setdar_002c-setsar" href="#setdar_002c-setsar">9.85 setdar, setsar</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-58" href="#Examples-58">9.85.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-setfield-1" href="#setfield-1">9.86 setfield</a></li>
    <li><a name="toc-showinfo" href="#showinfo">9.87 showinfo</a></li>
    <li><a name="toc-showpalette" href="#showpalette">9.88 showpalette</a></li>
    <li><a name="toc-shuffleplanes" href="#shuffleplanes">9.89 shuffleplanes</a></li>
    <li><a name="toc-signalstats" href="#signalstats">9.90 signalstats</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-59" href="#Examples-59">9.90.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-smartblur-1" href="#smartblur-1">9.91 smartblur</a></li>
    <li><a name="toc-stereo3d" href="#stereo3d">9.92 stereo3d</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-60" href="#Examples-60">9.92.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-spp-1" href="#spp-1">9.93 spp</a></li>
    <li><a name="toc-subtitles-1" href="#subtitles-1">9.94 subtitles</a></li>
    <li><a name="toc-super2xsai" href="#super2xsai">9.95 super2xsai</a></li>
    <li><a name="toc-swapuv" href="#swapuv">9.96 swapuv</a></li>
    <li><a name="toc-telecine" href="#telecine">9.97 telecine</a></li>
    <li><a name="toc-thumbnail" href="#thumbnail">9.98 thumbnail</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-61" href="#Examples-61">9.98.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-tile" href="#tile">9.99 tile</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-62" href="#Examples-62">9.99.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-tinterlace" href="#tinterlace">9.100 tinterlace</a></li>
    <li><a name="toc-transpose" href="#transpose">9.101 transpose</a></li>
    <li><a name="toc-trim" href="#trim">9.102 trim</a></li>
    <li><a name="toc-unsharp-1" href="#unsharp-1">9.103 unsharp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-63" href="#Examples-63">9.103.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-uspp" href="#uspp">9.104 uspp</a></li>
    <li><a name="toc-vidstabdetect-1" href="#vidstabdetect-1">9.105 vidstabdetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-64" href="#Examples-64">9.105.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-vidstabtransform-1" href="#vidstabtransform-1">9.106 vidstabtransform</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-2" href="#Options-2">9.106.1 Options</a></li>
      <li><a name="toc-Examples-65" href="#Examples-65">9.106.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-vflip" href="#vflip">9.107 vflip</a></li>
    <li><a name="toc-vignette-1" href="#vignette-1">9.108 vignette</a>
    <ul class="no-bullet">
      <li><a name="toc-Expressions" href="#Expressions">9.108.1 Expressions</a></li>
      <li><a name="toc-Examples-66" href="#Examples-66">9.108.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-w3fdif" href="#w3fdif">9.109 w3fdif</a></li>
    <li><a name="toc-xbr" href="#xbr">9.110 xbr</a></li>
    <li><a name="toc-yadif-1" href="#yadif-1">9.111 yadif</a></li>
    <li><a name="toc-zoompan" href="#zoompan">9.112 zoompan</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-67" href="#Examples-67">9.112.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-68" href="#Examples-68">10.2.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-69" href="#Examples-69">10.6.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Commands-6" href="#Commands-6">10.7.1 Commands</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-70" href="#Examples-70">12.1.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-concat" href="#concat">12.2 concat</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-71" href="#Examples-71">12.2.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-ebur128" href="#ebur128">12.3 ebur128</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-72" href="#Examples-72">12.3.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-interleave_002c-ainterleave" href="#interleave_002c-ainterleave">12.4 interleave, ainterleave</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-73" href="#Examples-73">12.4.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-74" href="#Examples-74">12.6.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      ...
      <li><a name="toc-Examples-75" href="#Examples-75">12.7.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-setpts_002c-asetpts" href="#setpts_002c-asetpts">12.8 setpts, asetpts</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-76" href="#Examples-76">12.8.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-settb_002c-asettb" href="#settb_002c-asettb">12.9 settb, asettb</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-77" href="#Examples-77">12.9.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showcqt" href="#showcqt">12.10 showcqt</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-78" href="#Examples-78">12.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showspectrum" href="#showspectrum">12.11 showspectrum</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-79" href="#Examples-79">12.11.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showwaves" href="#showwaves">12.12 showwaves</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-80" href="#Examples-80">12.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-split_002c-asplit" href="#split_002c-asplit">12.13 split, asplit</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-81" href="#Examples-81">12.13.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-zmq_002c-azmq" href="#zmq_002c-azmq">12.14 zmq, azmq</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-82" href="#Examples-82">12.14.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-83" href="#Examples-83">13.2.1 Examples</a></li>
    </ul></li>
  </ul></li>
...
<h2 class="chapter">2 Filtering Introduction<span class="pull-right"><a class="anchor hidden-xs" href="#Filtering-Introduction" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtering-Introduction" aria-hidden="true">TOC</a></span></h2>
...
<a name="graph2dot"></a>
<h2 class="chapter">3 graph2dot<span class="pull-right"><a class="anchor hidden-xs" href="#graph2dot" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-graph2dot" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">4 Filtergraph description<span class="pull-right"><a class="anchor hidden-xs" href="#Filtergraph-description" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtergraph-description" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">4.1 Filtergraph syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Filtergraph-syntax-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtergraph-syntax-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.2 Notes on filtergraph escaping<span class="pull-right"><a class="anchor hidden-xs" href="#Notes-on-filtergraph-escaping" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Notes-on-filtergraph-escaping" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">5 Timeline editing<span class="pull-right"><a class="anchor hidden-xs" href="#Timeline-editing" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Timeline-editing" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">6 Audio Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Filters" aria-hidden="true">TOC</a></span></h2>
...
<a name="adelay"></a>
<h3 class="section">6.1 adelay<span class="pull-right"><a class="anchor hidden-xs" href="#adelay" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-adelay" aria-hidden="true">TOC</a></span></h3>
...
<a name="aecho"></a>
<h3 class="section">6.2 aecho<span class="pull-right"><a class="anchor hidden-xs" href="#aecho" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aecho" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-1"></a>
<h4 class="subsection">6.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-1" aria-hidden="true">TOC</a></span></h4>
...
<a name="aeval"></a>
<h3 class="section">6.3 aeval<span class="pull-right"><a class="anchor hidden-xs" href="#aeval" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aeval" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-2"></a>
<h4 class="subsection">6.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-2" aria-hidden="true">TOC</a></span></h4>
...
<a name="afade"></a>
<h3 class="section">6.4 afade<span class="pull-right"><a class="anchor hidden-xs" href="#afade" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-afade" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-3"></a>
<h4 class="subsection">6.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-3" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">6.5 aformat<span class="pull-right"><a class="anchor hidden-xs" href="#aformat-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aformat-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="allpass"></a>
<h3 class="section">6.6 allpass<span class="pull-right"><a class="anchor hidden-xs" href="#allpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-allpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="amerge"></a>
<h3 class="section">6.7 amerge<span class="pull-right"><a class="anchor hidden-xs" href="#amerge" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amerge" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-4"></a>
<h4 class="subsection">6.7.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-4" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-4" aria-hidden="true">TOC</a></span></h4>
...
<a name="amix"></a>
<h3 class="section">6.8 amix<span class="pull-right"><a class="anchor hidden-xs" href="#amix" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amix" aria-hidden="true">TOC</a></span></h3>
...
<a name="anull"></a>
<h3 class="section">6.9 anull<span class="pull-right"><a class="anchor hidden-xs" href="#anull" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anull" aria-hidden="true">TOC</a></span></h3>

<p>Pass the audio source unchanged to the output.
</p>
<a name="apad"></a>
<h3 class="section">6.10 apad<span class="pull-right"><a class="anchor hidden-xs" href="#apad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-apad" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-5"></a>
<h4 class="subsection">6.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-5" aria-hidden="true">TOC</a></span></h4>
...
<a name="aphaser"></a>
<h3 class="section">6.11 aphaser<span class="pull-right"><a class="anchor hidden-xs" href="#aphaser" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aphaser" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">6.12 aresample<span class="pull-right"><a class="anchor hidden-xs" href="#aresample-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aresample-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-6"></a>
<h4 class="subsection">6.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-6" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-6" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">6.13 asetnsamples<span class="pull-right"><a class="anchor hidden-xs" href="#asetnsamples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asetnsamples" aria-hidden="true">TOC</a></span></h3>
...
<a name="asetrate"></a>
<h3 class="section">6.14 asetrate<span class="pull-right"><a class="anchor hidden-xs" href="#asetrate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asetrate" aria-hidden="true">TOC</a></span></h3>
...
<a name="ashowinfo"></a>
<h3 class="section">6.15 ashowinfo<span class="pull-right"><a class="anchor hidden-xs" href="#ashowinfo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ashowinfo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">6.16 astats<span class="pull-right"><a class="anchor hidden-xs" href="#astats-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-astats-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">6.17 astreamsync<span class="pull-right"><a class="anchor hidden-xs" href="#astreamsync" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-astreamsync" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-7"></a>
<h4 class="subsection">6.17.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-7" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-7" aria-hidden="true">TOC</a></span></h4>
...
<a name="asyncts"></a>
<h3 class="section">6.18 asyncts<span class="pull-right"><a class="anchor hidden-xs" href="#asyncts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asyncts" aria-hidden="true">TOC</a></span></h3>
...
<a name="atempo"></a>
<h3 class="section">6.19 atempo<span class="pull-right"><a class="anchor hidden-xs" href="#atempo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-atempo" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-8"></a>
<h4 class="subsection">6.19.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-8" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-8" aria-hidden="true">TOC</a></span></h4>
...
<a name="atrim"></a>
<h3 class="section">6.20 atrim<span class="pull-right"><a class="anchor hidden-xs" href="#atrim" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-atrim" aria-hidden="true">TOC</a></span></h3>
...
<a name="bandpass"></a>
<h3 class="section">6.21 bandpass<span class="pull-right"><a class="anchor hidden-xs" href="#bandpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bandpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="bandreject"></a>
<h3 class="section">6.22 bandreject<span class="pull-right"><a class="anchor hidden-xs" href="#bandreject" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bandreject" aria-hidden="true">TOC</a></span></h3>
...
<a name="bass"></a>
<h3 class="section">6.23 bass<span class="pull-right"><a class="anchor hidden-xs" href="#bass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bass" aria-hidden="true">TOC</a></span></h3>
...
<a name="biquad"></a>
<h3 class="section">6.24 biquad<span class="pull-right"><a class="anchor hidden-xs" href="#biquad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-biquad" aria-hidden="true">TOC</a></span></h3>
...
<a name="bs2b"></a>
<h3 class="section">6.25 bs2b<span class="pull-right"><a class="anchor hidden-xs" href="#bs2b" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bs2b" aria-hidden="true">TOC</a></span></h3>
...
<a name="channelmap"></a>
<h3 class="section">6.26 channelmap<span class="pull-right"><a class="anchor hidden-xs" href="#channelmap" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-channelmap" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">6.27 channelsplit<span class="pull-right"><a class="anchor hidden-xs" href="#channelsplit" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-channelsplit" aria-hidden="true">TOC</a></span></h3>
...
<a name="compand"></a>
<h3 class="section">6.28 compand<span class="pull-right"><a class="anchor hidden-xs" href="#compand" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-compand" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-9"></a>
<h4 class="subsection">6.28.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-9" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-9" aria-hidden="true">TOC</a></span></h4>
...
<a name="dcshift"></a>
<h3 class="section">6.29 dcshift<span class="pull-right"><a class="anchor hidden-xs" href="#dcshift" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dcshift" aria-hidden="true">TOC</a></span></h3>
...
<a name="earwax"></a>
<h3 class="section">6.30 earwax<span class="pull-right"><a class="anchor hidden-xs" href="#earwax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-earwax" aria-hidden="true">TOC</a></span></h3>
...
<a name="equalizer"></a>
<h3 class="section">6.31 equalizer<span class="pull-right"><a class="anchor hidden-xs" href="#equalizer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-equalizer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.31.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-10" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-10" aria-hidden="true">TOC</a></span></h4>
<ul>
...
<a name="flanger"></a>
<h3 class="section">6.32 flanger<span class="pull-right"><a class="anchor hidden-xs" href="#flanger" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-flanger" aria-hidden="true">TOC</a></span></h3>
...
<a name="highpass"></a>
<h3 class="section">6.33 highpass<span class="pull-right"><a class="anchor hidden-xs" href="#highpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-highpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="join"></a>
<h3 class="section">6.34 join<span class="pull-right"><a class="anchor hidden-xs" href="#join" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-join" aria-hidden="true">TOC</a></span></h3>
...
<a name="ladspa"></a>
<h3 class="section">6.35 ladspa<span class="pull-right"><a class="anchor hidden-xs" href="#ladspa" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ladspa" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.35.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-11" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-11" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands"></a>
<h4 class="subsection">6.35.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands" aria-hidden="true">TOC</a></span></h4>
...
<a name="lowpass"></a>
<h3 class="section">6.36 lowpass<span class="pull-right"><a class="anchor hidden-xs" href="#lowpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lowpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="pan"></a>
<h3 class="section">6.37 pan<span class="pull-right"><a class="anchor hidden-xs" href="#pan" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pan" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.37.1 Mixing examples<span class="pull-right"><a class="anchor hidden-xs" href="#Mixing-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Mixing-examples" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">6.37.2 Remapping examples<span class="pull-right"><a class="anchor hidden-xs" href="#Remapping-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Remapping-examples" aria-hidden="true">TOC</a></span></h4>
...
<a name="replaygain"></a>
<h3 class="section">6.38 replaygain<span class="pull-right"><a class="anchor hidden-xs" href="#replaygain" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-replaygain" aria-hidden="true">TOC</a></span></h3>
...
<a name="resample"></a>
<h3 class="section">6.39 resample<span class="pull-right"><a class="anchor hidden-xs" href="#resample" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-resample" aria-hidden="true">TOC</a></span></h3>

<p>Convert the audio sample format, sample rate and channel layout. It is
not meant to be used directly.
</p>
<a name="silencedetect"></a>
<h3 class="section">6.40 silencedetect<span class="pull-right"><a class="anchor hidden-xs" href="#silencedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-silencedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.40.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-12" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-12" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">6.41 silenceremove<span class="pull-right"><a class="anchor hidden-xs" href="#silenceremove" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-silenceremove" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.41.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-13" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-13" aria-hidden="true">TOC</a></span></h4>
...
<a name="treble"></a>
<h3 class="section">6.42 treble<span class="pull-right"><a class="anchor hidden-xs" href="#treble" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-treble" aria-hidden="true">TOC</a></span></h3>
...
<a name="volume"></a>
<h3 class="section">6.43 volume<span class="pull-right"><a class="anchor hidden-xs" href="#volume" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-volume" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-1"></a>
<h4 class="subsection">6.43.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-1" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">6.43.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-14" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-14" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">6.44 volumedetect<span class="pull-right"><a class="anchor hidden-xs" href="#volumedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-volumedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">6.44.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-15" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-15" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">7 Audio Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available audio sources.
</p>
<a name="abuffer"></a>
<h3 class="section">7.1 abuffer<span class="pull-right"><a class="anchor hidden-xs" href="#abuffer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-abuffer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">7.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-16" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-16" aria-hidden="true">TOC</a></span></h4>
...
<a name="aevalsrc"></a>
<h3 class="section">7.2 aevalsrc<span class="pull-right"><a class="anchor hidden-xs" href="#aevalsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aevalsrc" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">7.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-17" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-17" aria-hidden="true">TOC</a></span></h4>
...
<a name="anullsrc"></a>
<h3 class="section">7.3 anullsrc<span class="pull-right"><a class="anchor hidden-xs" href="#anullsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anullsrc" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">7.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-18" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-18" aria-hidden="true">TOC</a></span></h4>
...
<a name="flite"></a>
<h3 class="section">7.4 flite<span class="pull-right"><a class="anchor hidden-xs" href="#flite" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-flite" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">7.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-19" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-19" aria-hidden="true">TOC</a></span></h4>
...
<a name="sine"></a>
<h3 class="section">7.5 sine<span class="pull-right"><a class="anchor hidden-xs" href="#sine" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sine" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">7.5.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-20" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-20" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">8 Audio Sinks<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Sinks" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Sinks" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available audio sinks.
</p>
<a name="abuffersink"></a>
<h3 class="section">8.1 abuffersink<span class="pull-right"><a class="anchor hidden-xs" href="#abuffersink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-abuffersink" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">8.2 anullsink<span class="pull-right"><a class="anchor hidden-xs" href="#anullsink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anullsink" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">9 Video Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Filters" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">9.1 alphaextract<span class="pull-right"><a class="anchor hidden-xs" href="#alphaextract" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-alphaextract" aria-hidden="true">TOC</a></span></h3>
...
<a name="alphamerge"></a>
<h3 class="section">9.2 alphamerge<span class="pull-right"><a class="anchor hidden-xs" href="#alphamerge" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-alphamerge" aria-hidden="true">TOC</a></span></h3>
...
<a name="ass"></a>
<h3 class="section">9.3 ass<span class="pull-right"><a class="anchor hidden-xs" href="#ass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ass" aria-hidden="true">TOC</a></span></h3>
...
<a name="bbox"></a>
<h3 class="section">9.4 bbox<span class="pull-right"><a class="anchor hidden-xs" href="#bbox" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bbox" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.5 blackdetect<span class="pull-right"><a class="anchor hidden-xs" href="#blackdetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blackdetect" aria-hidden="true">TOC</a></span></h3>
...
<a name="blackframe"></a>
<h3 class="section">9.6 blackframe<span class="pull-right"><a class="anchor hidden-xs" href="#blackframe" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blackframe" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.7 blend, tblend<span class="pull-right"><a class="anchor hidden-xs" href="#blend_002c-tblend" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blend_002c-tblend" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.7.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-21" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-21" aria-hidden="true">TOC</a></span></h4>
...
<a name="boxblur"></a>
<h3 class="section">9.8 boxblur<span class="pull-right"><a class="anchor hidden-xs" href="#boxblur" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-boxblur" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.8.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-22" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-22" aria-hidden="true">TOC</a></span></h4>
...
<a name="codecview"></a>
<h3 class="section">9.9 codecview<span class="pull-right"><a class="anchor hidden-xs" href="#codecview" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-codecview" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.9.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-23" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-23" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.10 colorbalance<span class="pull-right"><a class="anchor hidden-xs" href="#colorbalance" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorbalance" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-24" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-24" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.11 colorlevels<span class="pull-right"><a class="anchor hidden-xs" href="#colorlevels" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorlevels" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.11.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-25" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-25" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.12 colorchannelmixer<span class="pull-right"><a class="anchor hidden-xs" href="#colorchannelmixer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorchannelmixer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-26" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-26" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.13 colormatrix<span class="pull-right"><a class="anchor hidden-xs" href="#colormatrix" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colormatrix" aria-hidden="true">TOC</a></span></h3>
...
<a name="copy"></a>
<h3 class="section">9.14 copy<span class="pull-right"><a class="anchor hidden-xs" href="#copy" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-copy" aria-hidden="true">TOC</a></span></h3>

<p>Copy the input source unchanged to the output. This is mainly useful for
testing purposes.
</p>
<a name="crop"></a>
<h3 class="section">9.15 crop<span class="pull-right"><a class="anchor hidden-xs" href="#crop" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-crop" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.15.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-27" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-27" aria-hidden="true">TOC</a></span></h4>
...
<a name="cropdetect"></a>
<h3 class="section">9.16 cropdetect<span class="pull-right"><a class="anchor hidden-xs" href="#cropdetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-cropdetect" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.17 curves<span class="pull-right"><a class="anchor hidden-xs" href="#curves-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-curves-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.17.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-28" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-28" aria-hidden="true">TOC</a></span></h4>
...
<a name="dctdnoiz"></a>
<h3 class="section">9.18 dctdnoiz<span class="pull-right"><a class="anchor hidden-xs" href="#dctdnoiz" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dctdnoiz" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.18.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-29" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-29" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.19 decimate<span class="pull-right"><a class="anchor hidden-xs" href="#decimate-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-decimate-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="dejudder"></a>
<h3 class="section">9.20 dejudder<span class="pull-right"><a class="anchor hidden-xs" href="#dejudder" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dejudder" aria-hidden="true">TOC</a></span></h3>
...
<a name="delogo"></a>
<h3 class="section">9.21 delogo<span class="pull-right"><a class="anchor hidden-xs" href="#delogo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-delogo" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.21.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-30" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-30" aria-hidden="true">TOC</a></span></h4>
...
<a name="deshake"></a>
<h3 class="section">9.22 deshake<span class="pull-right"><a class="anchor hidden-xs" href="#deshake" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-deshake" aria-hidden="true">TOC</a></span></h3>
...
<a name="drawbox"></a>
<h3 class="section">9.23 drawbox<span class="pull-right"><a class="anchor hidden-xs" href="#drawbox" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawbox" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.23.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-31" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-31" aria-hidden="true">TOC</a></span></h4>
...
<a name="drawgrid"></a>
<h3 class="section">9.24 drawgrid<span class="pull-right"><a class="anchor hidden-xs" href="#drawgrid" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawgrid" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.24.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-32" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-32" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.25 drawtext<span class="pull-right"><a class="anchor hidden-xs" href="#drawtext-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawtext-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Syntax"></a>
<h4 class="subsection">9.25.1 Syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Syntax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Syntax" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.25.2 Text expansion<span class="pull-right"><a class="anchor hidden-xs" href="#Text-expansion" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Text-expansion" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.25.3 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-33" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-33" aria-hidden="true">TOC</a></span></h4>
...
<a name="edgedetect"></a>
<h3 class="section">9.26 edgedetect<span class="pull-right"><a class="anchor hidden-xs" href="#edgedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-edgedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.26.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-34" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-34" aria-hidden="true">TOC</a></span></h4>
...
<a name="eq"></a>
<h3 class="section">9.27 eq<span class="pull-right"><a class="anchor hidden-xs" href="#eq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-eq" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-2"></a>
<h4 class="subsection">9.27.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-2" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.28 extractplanes<span class="pull-right"><a class="anchor hidden-xs" href="#extractplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-extractplanes" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.28.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-35" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-35" aria-hidden="true">TOC</a></span></h4>
...
<a name="elbg"></a>
<h3 class="section">9.29 elbg<span class="pull-right"><a class="anchor hidden-xs" href="#elbg" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-elbg" aria-hidden="true">TOC</a></span></h3>
...
<a name="fade"></a>
<h3 class="section">9.30 fade<span class="pull-right"><a class="anchor hidden-xs" href="#fade" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fade" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.30.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-36" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-36" aria-hidden="true">TOC</a></span></h4>
...
<a name="fftfilt"></a>
<h3 class="section">9.31 fftfilt<span class="pull-right"><a class="anchor hidden-xs" href="#fftfilt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fftfilt" aria-hidden="true">TOC</a></span></h3>
...
<a name="field"></a>
<h3 class="section">9.32 field<span class="pull-right"><a class="anchor hidden-xs" href="#field" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-field" aria-hidden="true">TOC</a></span></h3>
...
<a name="fieldmatch"></a>
<h3 class="section">9.33 fieldmatch<span class="pull-right"><a class="anchor hidden-xs" href="#fieldmatch" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fieldmatch" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.33.1 p/c/n/u/b meaning<span class="pull-right"><a class="anchor hidden-xs" href="#p_002fc_002fn_002fu_002fb-meaning-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-p_002fc_002fn_002fu_002fb-meaning-1" aria-hidden="true">TOC</a></span></h4>

<a name="p_002fc_002fn"></a>
<h4 class="subsubsection">9.33.1.1 p/c/n<span class="pull-right"><a class="anchor hidden-xs" href="#p_002fc_002fn" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-p_002fc_002fn" aria-hidden="true">TOC</a></span></h4>
...
<a name="u_002fb"></a>
<h4 class="subsubsection">9.33.1.2 u/b<span class="pull-right"><a class="anchor hidden-xs" href="#u_002fb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-u_002fb" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.33.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-37" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-37" aria-hidden="true">TOC</a></span></h4>
...
<a name="fieldorder"></a>
<h3 class="section">9.34 fieldorder<span class="pull-right"><a class="anchor hidden-xs" href="#fieldorder" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fieldorder" aria-hidden="true">TOC</a></span></h3>
...
<a name="fifo"></a>
<h3 class="section">9.35 fifo<span class="pull-right"><a class="anchor hidden-xs" href="#fifo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fifo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.36 format<span class="pull-right"><a class="anchor hidden-xs" href="#format-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-format-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.36.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-38" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-38" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.37 fps<span class="pull-right"><a class="anchor hidden-xs" href="#fps-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fps-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.37.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-39" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-39" aria-hidden="true">TOC</a></span></h4>
...
<a name="framepack"></a>
<h3 class="section">9.38 framepack<span class="pull-right"><a class="anchor hidden-xs" href="#framepack" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-framepack" aria-hidden="true">TOC</a></span></h3>
...
<a name="framestep"></a>
<h3 class="section">9.39 framestep<span class="pull-right"><a class="anchor hidden-xs" href="#framestep" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-framestep" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.40 frei0r<span class="pull-right"><a class="anchor hidden-xs" href="#frei0r-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-frei0r-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.40.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-40" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-40" aria-hidden="true">TOC</a></span></h4>
...
<a name="fspp"></a>
<h3 class="section">9.41 fspp<span class="pull-right"><a class="anchor hidden-xs" href="#fspp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fspp" aria-hidden="true">TOC</a></span></h3>
...
<a name="geq"></a>
<h3 class="section">9.42 geq<span class="pull-right"><a class="anchor hidden-xs" href="#geq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-geq" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.42.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-41" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-41" aria-hidden="true">TOC</a></span></h4>
...
<a name="gradfun"></a>
<h3 class="section">9.43 gradfun<span class="pull-right"><a class="anchor hidden-xs" href="#gradfun" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-gradfun" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.43.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-42" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-42" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.44 haldclut<span class="pull-right"><a class="anchor hidden-xs" href="#haldclut-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-haldclut-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.44.1 Workflow examples<span class="pull-right"><a class="anchor hidden-xs" href="#Workflow-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Workflow-examples" aria-hidden="true">TOC</a></span></h4>

<a name="Hald-CLUT-video-stream"></a>
<h4 class="subsubsection">9.44.1.1 Hald CLUT video stream<span class="pull-right"><a class="anchor hidden-xs" href="#Hald-CLUT-video-stream" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Hald-CLUT-video-stream" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsubsection">9.44.1.2 Hald CLUT with preview<span class="pull-right"><a class="anchor hidden-xs" href="#Hald-CLUT-with-preview" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Hald-CLUT-with-preview" aria-hidden="true">TOC</a></span></h4>
...
<a name="hflip"></a>
<h3 class="section">9.45 hflip<span class="pull-right"><a class="anchor hidden-xs" href="#hflip" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hflip" aria-hidden="true">TOC</a></span></h3>
...
<a name="histeq"></a>
<h3 class="section">9.46 histeq<span class="pull-right"><a class="anchor hidden-xs" href="#histeq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-histeq" aria-hidden="true">TOC</a></span></h3>
...
<a name="histogram"></a>
<h3 class="section">9.47 histogram<span class="pull-right"><a class="anchor hidden-xs" href="#histogram" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-histogram" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.47.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-43" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-43" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.48 hqdn3d<span class="pull-right"><a class="anchor hidden-xs" href="#hqdn3d-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hqdn3d-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="hqx"></a>
<h3 class="section">9.49 hqx<span class="pull-right"><a class="anchor hidden-xs" href="#hqx" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hqx" aria-hidden="true">TOC</a></span></h3>
...
<a name="hue"></a>
<h3 class="section">9.50 hue<span class="pull-right"><a class="anchor hidden-xs" href="#hue" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hue" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.50.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-44" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-44" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands-3"></a>
<h4 class="subsection">9.50.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-3" aria-hidden="true">TOC</a></span></h4>
...
<a name="idet"></a>
<h3 class="section">9.51 idet<span class="pull-right"><a class="anchor hidden-xs" href="#idet" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-idet" aria-hidden="true">TOC</a></span></h3>
...
<a name="il"></a>
<h3 class="section">9.52 il<span class="pull-right"><a class="anchor hidden-xs" href="#il" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-il" aria-hidden="true">TOC</a></span></h3>
...
<a name="interlace"></a>
<h3 class="section">9.53 interlace<span class="pull-right"><a class="anchor hidden-xs" href="#interlace" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-interlace" aria-hidden="true">TOC</a></span></h3>
...
<a name="kerndeint"></a>
<h3 class="section">9.54 kerndeint<span class="pull-right"><a class="anchor hidden-xs" href="#kerndeint" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-kerndeint" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.54.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-45" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-45" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.55 lenscorrection<span class="pull-right"><a class="anchor hidden-xs" href="#lenscorrection" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lenscorrection" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options"></a>
<h4 class="subsection">9.55.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.56 lut3d<span class="pull-right"><a class="anchor hidden-xs" href="#lut3d-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lut3d-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.57 lut, lutrgb, lutyuv<span class="pull-right"><a class="anchor hidden-xs" href="#lut_002c-lutrgb_002c-lutyuv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lut_002c-lutrgb_002c-lutyuv" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.57.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-46" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-46" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.58 mergeplanes<span class="pull-right"><a class="anchor hidden-xs" href="#mergeplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mergeplanes" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.58.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-47" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-47" aria-hidden="true">TOC</a></span></h4>
...
<a name="mcdeint"></a>
<h3 class="section">9.59 mcdeint<span class="pull-right"><a class="anchor hidden-xs" href="#mcdeint" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mcdeint" aria-hidden="true">TOC</a></span></h3>
...
<a name="mpdecimate"></a>
<h3 class="section">9.60 mpdecimate<span class="pull-right"><a class="anchor hidden-xs" href="#mpdecimate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mpdecimate" aria-hidden="true">TOC</a></span></h3>
...
<a name="negate"></a>
<h3 class="section">9.61 negate<span class="pull-right"><a class="anchor hidden-xs" href="#negate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-negate" aria-hidden="true">TOC</a></span></h3>
...
<a name="noformat"></a>
<h3 class="section">9.62 noformat<span class="pull-right"><a class="anchor hidden-xs" href="#noformat" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-noformat" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.62.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-48" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-48" aria-hidden="true">TOC</a></span></h4>
...
<a name="noise"></a>
<h3 class="section">9.63 noise<span class="pull-right"><a class="anchor hidden-xs" href="#noise" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-noise" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.63.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-49" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-49" aria-hidden="true">TOC</a></span></h4>
...
<a name="null"></a>
<h3 class="section">9.64 null<span class="pull-right"><a class="anchor hidden-xs" href="#null" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-null" aria-hidden="true">TOC</a></span></h3>

<p>Pass the video source unchanged to the output.
</p>
<a name="ocv"></a>
<h3 class="section">9.65 ocv<span class="pull-right"><a class="anchor hidden-xs" href="#ocv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ocv" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.65.1 dilate<span class="pull-right"><a class="anchor hidden-xs" href="#dilate-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dilate-1" aria-hidden="true">TOC</a></span></h4>
...
<a name="erode"></a>
<h4 class="subsection">9.65.2 erode<span class="pull-right"><a class="anchor hidden-xs" href="#erode" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-erode" aria-hidden="true">TOC</a></span></h4>
...
<a name="smooth"></a>
<h4 class="subsection">9.65.3 smooth<span class="pull-right"><a class="anchor hidden-xs" href="#smooth" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-smooth" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.66 overlay<span class="pull-right"><a class="anchor hidden-xs" href="#overlay-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-overlay-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-4"></a>
<h4 class="subsection">9.66.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-4" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-4" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.66.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-50" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-50" aria-hidden="true">TOC</a></span></h4>
...
<a name="owdenoise"></a>
<h3 class="section">9.67 owdenoise<span class="pull-right"><a class="anchor hidden-xs" href="#owdenoise" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-owdenoise" aria-hidden="true">TOC</a></span></h3>
...
<a name="pad"></a>
<h3 class="section">9.68 pad<span class="pull-right"><a class="anchor hidden-xs" href="#pad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pad" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.68.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-51" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-51" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.69 palettegen<span class="pull-right"><a class="anchor hidden-xs" href="#palettegen-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-palettegen-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.69.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-52" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-52" aria-hidden="true">TOC</a></span></h4>
...
<a name="paletteuse"></a>
<h3 class="section">9.70 paletteuse<span class="pull-right"><a class="anchor hidden-xs" href="#paletteuse" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-paletteuse" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.70.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-53" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-53" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.71 perspective<span class="pull-right"><a class="anchor hidden-xs" href="#perspective" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-perspective" aria-hidden="true">TOC</a></span></h3>
...
<a name="phase"></a>
<h3 class="section">9.72 phase<span class="pull-right"><a class="anchor hidden-xs" href="#phase" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-phase" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.73 pixdesctest<span class="pull-right"><a class="anchor hidden-xs" href="#pixdesctest" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pixdesctest" aria-hidden="true">TOC</a></span></h3>
...
<a name="pp"></a>
<h3 class="section">9.74 pp<span class="pull-right"><a class="anchor hidden-xs" href="#pp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pp" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.74.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-54" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-54" aria-hidden="true">TOC</a></span></h4>
...
<a name="pp7"></a>
<h3 class="section">9.75 pp7<span class="pull-right"><a class="anchor hidden-xs" href="#pp7" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pp7" aria-hidden="true">TOC</a></span></h3>
...
<a name="psnr"></a>
<h3 class="section">9.76 psnr<span class="pull-right"><a class="anchor hidden-xs" href="#psnr" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-psnr" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.77 pullup<span class="pull-right"><a class="anchor hidden-xs" href="#pullup-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pullup-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="qp"></a>
<h3 class="section">9.78 qp<span class="pull-right"><a class="anchor hidden-xs" href="#qp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-qp" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.78.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-55" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-55" aria-hidden="true">TOC</a></span></h4>
...
<a name="removelogo"></a>
<h3 class="section">9.79 removelogo<span class="pull-right"><a class="anchor hidden-xs" href="#removelogo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-removelogo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.80 repeatfields<span class="pull-right"><a class="anchor hidden-xs" href="#repeatfields" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-repeatfields" aria-hidden="true">TOC</a></span></h3>

<p>This filter uses the repeat_field flag from the Video ES headers and hard repeats
fields based on its value.
</p>
<a name="rotate"></a>
<h3 class="section">9.81 rotate<span class="pull-right"><a class="anchor hidden-xs" href="#rotate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rotate" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.81.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-56" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-56" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands-5"></a>
<h4 class="subsection">9.81.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-5" aria-hidden="true">TOC</a></span></h4>
...
<a name="sab"></a>
<h3 class="section">9.82 sab<span class="pull-right"><a class="anchor hidden-xs" href="#sab" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sab" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.83 scale<span class="pull-right"><a class="anchor hidden-xs" href="#scale-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-scale-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-1"></a>
<h4 class="subsection">9.83.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-1" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.83.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-57" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-57" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.84 separatefields<span class="pull-right"><a class="anchor hidden-xs" href="#separatefields" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-separatefields" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.85 setdar, setsar<span class="pull-right"><a class="anchor hidden-xs" href="#setdar_002c-setsar" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setdar_002c-setsar" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.85.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-58" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-58" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.86 setfield<span class="pull-right"><a class="anchor hidden-xs" href="#setfield-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setfield-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="showinfo"></a>
<h3 class="section">9.87 showinfo<span class="pull-right"><a class="anchor hidden-xs" href="#showinfo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showinfo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.88 showpalette<span class="pull-right"><a class="anchor hidden-xs" href="#showpalette" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showpalette" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.89 shuffleplanes<span class="pull-right"><a class="anchor hidden-xs" href="#shuffleplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-shuffleplanes" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.90 signalstats<span class="pull-right"><a class="anchor hidden-xs" href="#signalstats" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-signalstats" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.90.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-59" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-59" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.91 smartblur<span class="pull-right"><a class="anchor hidden-xs" href="#smartblur-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-smartblur-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="stereo3d"></a>
<h3 class="section">9.92 stereo3d<span class="pull-right"><a class="anchor hidden-xs" href="#stereo3d" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-stereo3d" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.92.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-60" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-60" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.93 spp<span class="pull-right"><a class="anchor hidden-xs" href="#spp-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-spp-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.94 subtitles<span class="pull-right"><a class="anchor hidden-xs" href="#subtitles-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-subtitles-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="super2xsai"></a>
<h3 class="section">9.95 super2xsai<span class="pull-right"><a class="anchor hidden-xs" href="#super2xsai" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-super2xsai" aria-hidden="true">TOC</a></span></h3>
...
<a name="swapuv"></a>
<h3 class="section">9.96 swapuv<span class="pull-right"><a class="anchor hidden-xs" href="#swapuv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-swapuv" aria-hidden="true">TOC</a></span></h3>
<p>Swap U &amp; V plane.
</p>
<a name="telecine"></a>
<h3 class="section">9.97 telecine<span class="pull-right"><a class="anchor hidden-xs" href="#telecine" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-telecine" aria-hidden="true">TOC</a></span></h3>
...
<a name="thumbnail"></a>
<h3 class="section">9.98 thumbnail<span class="pull-right"><a class="anchor hidden-xs" href="#thumbnail" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-thumbnail" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.98.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-61" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-61" aria-hidden="true">TOC</a></span></h4>
...
<a name="tile"></a>
<h3 class="section">9.99 tile<span class="pull-right"><a class="anchor hidden-xs" href="#tile" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tile" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.99.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-62" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-62" aria-hidden="true">TOC</a></span></h4>
...
<a name="tinterlace"></a>
<h3 class="section">9.100 tinterlace<span class="pull-right"><a class="anchor hidden-xs" href="#tinterlace" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tinterlace" aria-hidden="true">TOC</a></span></h3>
...
<a name="transpose"></a>
<h3 class="section">9.101 transpose<span class="pull-right"><a class="anchor hidden-xs" href="#transpose" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-transpose" aria-hidden="true">TOC</a></span></h3>
...
<a name="trim"></a>
<h3 class="section">9.102 trim<span class="pull-right"><a class="anchor hidden-xs" href="#trim" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-trim" aria-hidden="true">TOC</a></span></h3>
<p>Trim the input so that the output contains one continuous subpart of the input.
</p>
<p>It accepts the following parameters:
</p><dl compact="compact">
...
<h3 class="section">9.103 unsharp<span class="pull-right"><a class="anchor hidden-xs" href="#unsharp-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-unsharp-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.103.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-63" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-63" aria-hidden="true">TOC</a></span></h4>
...
<a name="uspp"></a>
<h3 class="section">9.104 uspp<span class="pull-right"><a class="anchor hidden-xs" href="#uspp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-uspp" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.105 vidstabdetect<span class="pull-right"><a class="anchor hidden-xs" href="#vidstabdetect-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vidstabdetect-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.105.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-64" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-64" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">9.106 vidstabtransform<span class="pull-right"><a class="anchor hidden-xs" href="#vidstabtransform-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vidstabtransform-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-2"></a>
<h4 class="subsection">9.106.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-2" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.106.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-65" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-65" aria-hidden="true">TOC</a></span></h4>
...
<a name="vflip"></a>
<h3 class="section">9.107 vflip<span class="pull-right"><a class="anchor hidden-xs" href="#vflip" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vflip" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.108 vignette<span class="pull-right"><a class="anchor hidden-xs" href="#vignette-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vignette-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.108.1 Expressions<span class="pull-right"><a class="anchor hidden-xs" href="#Expressions" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Expressions" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">9.108.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-66" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-66" aria-hidden="true">TOC</a></span></h4>
...
<a name="w3fdif"></a>
<h3 class="section">9.109 w3fdif<span class="pull-right"><a class="anchor hidden-xs" href="#w3fdif" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-w3fdif" aria-hidden="true">TOC</a></span></h3>
...
<a name="xbr"></a>
<h3 class="section">9.110 xbr<span class="pull-right"><a class="anchor hidden-xs" href="#xbr" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-xbr" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">9.111 yadif<span class="pull-right"><a class="anchor hidden-xs" href="#yadif-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-yadif-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="zoompan"></a>
<h3 class="section">9.112 zoompan<span class="pull-right"><a class="anchor hidden-xs" href="#zoompan" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-zoompan" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">9.112.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-67" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-67" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">10 Video Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available video sources.
</p>
<a name="buffer"></a>
<h3 class="section">10.1 buffer<span class="pull-right"><a class="anchor hidden-xs" href="#buffer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-buffer" aria-hidden="true">TOC</a></span></h3>
...
<a name="cellauto"></a>
<h3 class="section">10.2 cellauto<span class="pull-right"><a class="anchor hidden-xs" href="#cellauto" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-cellauto" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">10.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-68" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-68" aria-hidden="true">TOC</a></span></h4>
...
<a name="mandelbrot"></a>
<h3 class="section">10.3 mandelbrot<span class="pull-right"><a class="anchor hidden-xs" href="#mandelbrot" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mandelbrot" aria-hidden="true">TOC</a></span></h3>
...
<a name="mptestsrc"></a>
<h3 class="section">10.4 mptestsrc<span class="pull-right"><a class="anchor hidden-xs" href="#mptestsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mptestsrc" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">10.5 frei0r_src<span class="pull-right"><a class="anchor hidden-xs" href="#frei0r_005fsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-frei0r_005fsrc" aria-hidden="true">TOC</a></span></h3>
...
<a name="life"></a>
<h3 class="section">10.6 life<span class="pull-right"><a class="anchor hidden-xs" href="#life" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-life" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">10.6.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-69" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-69" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">10.7 color, haldclutsrc, nullsrc, rgbtestsrc, smptebars, smptehdbars, testsrc<span class="pull-right"><a class="anchor hidden-xs" href="#color_002c-haldclutsrc_002c-nullsrc_002c-rgbtestsrc_002c-smptebars_002c-smptehdbars_002c-testsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-color_002c-haldclutsrc_002c-nullsrc_002c-rgbtestsrc_002c-smptebars_002c-smptehdbars_002c-testsrc" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-6"></a>
<h4 class="subsection">10.7.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-6" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-6" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">11 Video Sinks<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Sinks" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Sinks" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available video sinks.
</p>
<a name="buffersink"></a>
<h3 class="section">11.1 buffersink<span class="pull-right"><a class="anchor hidden-xs" href="#buffersink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-buffersink" aria-hidden="true">TOC</a></span></h3>
...
<a name="nullsink"></a>
<h3 class="section">11.2 nullsink<span class="pull-right"><a class="anchor hidden-xs" href="#nullsink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-nullsink" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">12 Multimedia Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Multimedia-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Multimedia-Filters" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available multimedia filters.
</p>
<a name="avectorscope"></a>
<h3 class="section">12.1 avectorscope<span class="pull-right"><a class="anchor hidden-xs" href="#avectorscope" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-avectorscope" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-70" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-70" aria-hidden="true">TOC</a></span></h4>
...
<a name="concat"></a>
<h3 class="section">12.2 concat<span class="pull-right"><a class="anchor hidden-xs" href="#concat" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-concat" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-71" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-71" aria-hidden="true">TOC</a></span></h4>
...
<a name="ebur128"></a>
<h3 class="section">12.3 ebur128<span class="pull-right"><a class="anchor hidden-xs" href="#ebur128" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ebur128" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-72" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-72" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.4 interleave, ainterleave<span class="pull-right"><a class="anchor hidden-xs" href="#interleave_002c-ainterleave" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-interleave_002c-ainterleave" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-73" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-73" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.5 perms, aperms<span class="pull-right"><a class="anchor hidden-xs" href="#perms_002c-aperms" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-perms_002c-aperms" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">12.6 select, aselect<span class="pull-right"><a class="anchor hidden-xs" href="#select_002c-aselect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-select_002c-aselect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.6.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-74" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-74" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.7 sendcmd, asendcmd<span class="pull-right"><a class="anchor hidden-xs" href="#sendcmd_002c-asendcmd" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sendcmd_002c-asendcmd" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.7.1 Commands syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-syntax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-syntax" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">12.7.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-75" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-75" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.8 setpts, asetpts<span class="pull-right"><a class="anchor hidden-xs" href="#setpts_002c-asetpts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setpts_002c-asetpts" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.8.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-76" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-76" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.9 settb, asettb<span class="pull-right"><a class="anchor hidden-xs" href="#settb_002c-asettb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-settb_002c-asettb" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.9.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-77" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-77" aria-hidden="true">TOC</a></span></h4>
...
<a name="showcqt"></a>
<h3 class="section">12.10 showcqt<span class="pull-right"><a class="anchor hidden-xs" href="#showcqt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showcqt" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-78" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-78" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.11 showspectrum<span class="pull-right"><a class="anchor hidden-xs" href="#showspectrum" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showspectrum" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.11.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-79" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-79" aria-hidden="true">TOC</a></span></h4>
...
<a name="showwaves"></a>
<h3 class="section">12.12 showwaves<span class="pull-right"><a class="anchor hidden-xs" href="#showwaves" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showwaves" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-80" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-80" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.13 split, asplit<span class="pull-right"><a class="anchor hidden-xs" href="#split_002c-asplit" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-split_002c-asplit" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.13.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-81" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-81" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">12.14 zmq, azmq<span class="pull-right"><a class="anchor hidden-xs" href="#zmq_002c-azmq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-zmq_002c-azmq" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">12.14.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-82" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-82" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">13 Multimedia Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Multimedia-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Multimedia-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available multimedia sources.
</p>
<a name="amovie"></a>
<h3 class="section">13.1 amovie<span class="pull-right"><a class="anchor hidden-xs" href="#amovie" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amovie" aria-hidden="true">TOC</a></span></h3>

<p>This is the same as <a href="#movie">movie</a> source, except it selects an audio
stream by default.
</p>
<a name="movie"></a><a name="movie-1"></a>
<h3 class="section">13.2 movie<span class="pull-right"><a class="anchor hidden-xs" href="#movie-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-movie-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">13.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-83" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-83" aria-hidden="true">TOC</a></span></h4>
...
<a name="See-Also"></a>
<h2 class="chapter">14 See Also<span class="pull-right"><a class="anchor hidden-xs" href="#See-Also" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-See-Also" aria-hidden="true">TOC</a></span></h2>
...
<a name="Authors"></a>
<h2 class="chapter">15 Authors<span class="pull-right"><a class="anchor hidden-xs" href="#Authors" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Authors" aria-hidden="true">TOC</a></span></h2>
