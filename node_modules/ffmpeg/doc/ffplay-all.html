...
<ul class="no-bullet">
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-1" href="#Examples-1">4.3.1 Examples</a></li>
    </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Options-2" href="#Options-2">10.5.1 Options</a></li>
    </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-imxdump" href="#imxdump">12.5 imxdump</a></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-apng" href="#apng">14.2 apng</a></li>
    <li><a name="toc-asf" href="#asf">14.3 asf</a></li>
    <li><a name="toc-concat-1" href="#concat-1">14.4 concat</a>
    <ul class="no-bullet">
      <li><a name="toc-Syntax-1" href="#Syntax-1">14.4.1 Syntax</a></li>
      <li><a name="toc-Options-5" href="#Options-5">14.4.2 Options</a></li>
    </ul></li>
    <li><a name="toc-flv" href="#flv">14.5 flv</a></li>
    <li><a name="toc-libgme" href="#libgme">14.6 libgme</a></li>
    <li><a name="toc-libquvi" href="#libquvi">14.7 libquvi</a></li>
    <li><a name="toc-gif" href="#gif">14.8 gif</a></li>
    <li><a name="toc-image2" href="#image2">14.9 image2</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-2" href="#Examples-2">14.9.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-mpegts" href="#mpegts">14.10 mpegts</a></li>
    <li><a name="toc-rawvideo-1" href="#rawvideo-1">14.11 rawvideo</a></li>
    <li><a name="toc-sbg" href="#sbg">14.12 sbg</a></li>
    <li><a name="toc-tedcaptions" href="#tedcaptions">14.13 tedcaptions</a></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-concat-2" href="#concat-2">16.3 concat</a></li>
    ...
    <li><a name="toc-Icecast" href="#Icecast">16.11 Icecast</a></li>
    <li><a name="toc-mmst" href="#mmst">16.12 mmst</a></li>
    <li><a name="toc-mmsh" href="#mmsh">16.13 mmsh</a></li>
    <li><a name="toc-md5" href="#md5">16.14 md5</a></li>
    <li><a name="toc-pipe" href="#pipe">16.15 pipe</a></li>
    <li><a name="toc-rtmp" href="#rtmp">16.16 rtmp</a></li>
    <li><a name="toc-rtmpe" href="#rtmpe">16.17 rtmpe</a></li>
    <li><a name="toc-rtmps" href="#rtmps">16.18 rtmps</a></li>
    <li><a name="toc-rtmpt" href="#rtmpt">16.19 rtmpt</a></li>
    <li><a name="toc-rtmpte" href="#rtmpte">16.20 rtmpte</a></li>
    <li><a name="toc-rtmpts" href="#rtmpts">16.21 rtmpts</a></li>
    <li><a name="toc-libsmbclient" href="#libsmbclient">16.22 libsmbclient</a></li>
    <li><a name="toc-libssh" href="#libssh">16.23 libssh</a></li>
    <li><a name="toc-librtmp-rtmp_002c-rtmpe_002c-rtmps_002c-rtmpt_002c-rtmpte" href="#librtmp-rtmp_002c-rtmpe_002c-rtmps_002c-rtmpt_002c-rtmpte">16.24 librtmp rtmp, rtmpe, rtmps, rtmpt, rtmpte</a></li>
    <li><a name="toc-rtp" href="#rtp">16.25 rtp</a></li>
    <li><a name="toc-rtsp" href="#rtsp">16.26 rtsp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-3" href="#Examples-3">16.26.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-sap" href="#sap">16.27 sap</a>
    <ul class="no-bullet">
      <li><a name="toc-Muxer" href="#Muxer">16.27.1 Muxer</a></li>
      <li><a name="toc-Demuxer" href="#Demuxer">16.27.2 Demuxer</a></li>
    </ul></li>
    <li><a name="toc-sctp" href="#sctp">16.28 sctp</a></li>
    <li><a name="toc-srtp" href="#srtp">16.29 srtp</a></li>
    <li><a name="toc-subfile" href="#subfile">16.30 subfile</a></li>
    <li><a name="toc-tcp" href="#tcp">16.31 tcp</a></li>
    <li><a name="toc-tls" href="#tls">16.32 tls</a></li>
    <li><a name="toc-udp" href="#udp">16.33 udp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-4" href="#Examples-4">16.33.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-unix" href="#unix">16.34 unix</a></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-avfoundation" href="#avfoundation">18.2 avfoundation</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-6" href="#Options-6">18.2.1 Options</a></li>
  ...
  <ul class="no-bullet">
    <li><a name="toc-adelay" href="#adelay">25.1 adelay</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-12" href="#Examples-12">25.1.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aecho" href="#aecho">25.2 aecho</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-13" href="#Examples-13">25.2.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aeval" href="#aeval">25.3 aeval</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-14" href="#Examples-14">25.3.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-afade" href="#afade">25.4 afade</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-15" href="#Examples-15">25.4.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aformat-1" href="#aformat-1">25.5 aformat</a></li>
    <li><a name="toc-allpass" href="#allpass">25.6 allpass</a></li>
    <li><a name="toc-amerge" href="#amerge">25.7 amerge</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-16" href="#Examples-16">25.7.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-amix" href="#amix">25.8 amix</a></li>
    <li><a name="toc-anull" href="#anull">25.9 anull</a></li>
    <li><a name="toc-apad" href="#apad">25.10 apad</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-17" href="#Examples-17">25.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aphaser" href="#aphaser">25.11 aphaser</a></li>
    <li><a name="toc-aresample-1" href="#aresample-1">25.12 aresample</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-18" href="#Examples-18">25.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-asetnsamples" href="#asetnsamples">25.13 asetnsamples</a></li>
    <li><a name="toc-asetrate" href="#asetrate">25.14 asetrate</a></li>
    <li><a name="toc-ashowinfo" href="#ashowinfo">25.15 ashowinfo</a></li>
    <li><a name="toc-astats-1" href="#astats-1">25.16 astats</a></li>
    <li><a name="toc-astreamsync" href="#astreamsync">25.17 astreamsync</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-19" href="#Examples-19">25.17.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-asyncts" href="#asyncts">25.18 asyncts</a></li>
    <li><a name="toc-atempo" href="#atempo">25.19 atempo</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-20" href="#Examples-20">25.19.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-atrim" href="#atrim">25.20 atrim</a></li>
    <li><a name="toc-bandpass" href="#bandpass">25.21 bandpass</a></li>
    <li><a name="toc-bandreject" href="#bandreject">25.22 bandreject</a></li>
    <li><a name="toc-bass" href="#bass">25.23 bass</a></li>
    <li><a name="toc-biquad" href="#biquad">25.24 biquad</a></li>
    <li><a name="toc-bs2b" href="#bs2b">25.25 bs2b</a></li>
    ...
    <li><a name="toc-dcshift" href="#dcshift">25.29 dcshift</a></li>
    <li><a name="toc-earwax" href="#earwax">25.30 earwax</a></li>
    <li><a name="toc-equalizer" href="#equalizer">25.31 equalizer</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-22" href="#Examples-22">25.31.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-flanger" href="#flanger">25.32 flanger</a></li>
    <li><a name="toc-highpass" href="#highpass">25.33 highpass</a></li>
    <li><a name="toc-join" href="#join">25.34 join</a></li>
    <li><a name="toc-ladspa" href="#ladspa">25.35 ladspa</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-23" href="#Examples-23">25.35.1 Examples</a></li>
      <li><a name="toc-Commands" href="#Commands">25.35.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-lowpass" href="#lowpass">25.36 lowpass</a></li>
    <li><a name="toc-pan" href="#pan">25.37 pan</a>
    <ul class="no-bullet">
      <li><a name="toc-Mixing-examples" href="#Mixing-examples">25.37.1 Mixing examples</a></li>
      <li><a name="toc-Remapping-examples" href="#Remapping-examples">25.37.2 Remapping examples</a></li>
    </ul></li>
    <li><a name="toc-replaygain" href="#replaygain">25.38 replaygain</a></li>
    <li><a name="toc-resample" href="#resample">25.39 resample</a></li>
    <li><a name="toc-silencedetect" href="#silencedetect">25.40 silencedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-24" href="#Examples-24">25.40.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-silenceremove" href="#silenceremove">25.41 silenceremove</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-25" href="#Examples-25">25.41.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-treble" href="#treble">25.42 treble</a></li>
    <li><a name="toc-volume" href="#volume">25.43 volume</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-1" href="#Commands-1">25.43.1 Commands</a></li>
      <li><a name="toc-Examples-26" href="#Examples-26">25.43.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-volumedetect" href="#volumedetect">25.44 volumedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-27" href="#Examples-27">25.44.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-28" href="#Examples-28">26.1.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-aevalsrc" href="#aevalsrc">26.2 aevalsrc</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-29" href="#Examples-29">26.2.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-anullsrc" href="#anullsrc">26.3 anullsrc</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-30" href="#Examples-30">26.3.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-flite" href="#flite">26.4 flite</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-31" href="#Examples-31">26.4.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-sine" href="#sine">26.5 sine</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-32" href="#Examples-32">26.5.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <li><a name="toc-blend_002c-tblend" href="#blend_002c-tblend">28.7 blend, tblend</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-33" href="#Examples-33">28.7.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-boxblur" href="#boxblur">28.8 boxblur</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-34" href="#Examples-34">28.8.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-codecview" href="#codecview">28.9 codecview</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-35" href="#Examples-35">28.9.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorbalance" href="#colorbalance">28.10 colorbalance</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-36" href="#Examples-36">28.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorlevels" href="#colorlevels">28.11 colorlevels</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-37" href="#Examples-37">28.11.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colorchannelmixer" href="#colorchannelmixer">28.12 colorchannelmixer</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-38" href="#Examples-38">28.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-colormatrix" href="#colormatrix">28.13 colormatrix</a></li>
    <li><a name="toc-copy" href="#copy">28.14 copy</a></li>
    <li><a name="toc-crop" href="#crop">28.15 crop</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-39" href="#Examples-39">28.15.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-cropdetect" href="#cropdetect">28.16 cropdetect</a></li>
    <li><a name="toc-curves-1" href="#curves-1">28.17 curves</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-40" href="#Examples-40">28.17.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-dctdnoiz" href="#dctdnoiz">28.18 dctdnoiz</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-41" href="#Examples-41">28.18.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-decimate-1" href="#decimate-1">28.19 decimate</a></li>
    <li><a name="toc-dejudder" href="#dejudder">28.20 dejudder</a></li>
    <li><a name="toc-delogo" href="#delogo">28.21 delogo</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-42" href="#Examples-42">28.21.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-deshake" href="#deshake">28.22 deshake</a></li>
    <li><a name="toc-drawbox" href="#drawbox">28.23 drawbox</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-43" href="#Examples-43">28.23.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-drawgrid" href="#drawgrid">28.24 drawgrid</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-44" href="#Examples-44">28.24.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-drawtext-1" href="#drawtext-1">28.25 drawtext</a>
    <ul class="no-bullet">
      <li><a name="toc-Syntax-2" href="#Syntax-2">28.25.1 Syntax</a></li>
      <li><a name="toc-Text-expansion" href="#Text-expansion">28.25.2 Text expansion</a></li>
      <li><a name="toc-Examples-45" href="#Examples-45">28.25.3 Examples</a></li>
    </ul></li>
    <li><a name="toc-edgedetect" href="#edgedetect">28.26 edgedetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-46" href="#Examples-46">28.26.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-eq" href="#eq">28.27 eq</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-2" href="#Commands-2">28.27.1 Commands</a></li>
    </ul></li>
    <li><a name="toc-extractplanes" href="#extractplanes">28.28 extractplanes</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-47" href="#Examples-47">28.28.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-elbg" href="#elbg">28.29 elbg</a></li>
    <li><a name="toc-fade" href="#fade">28.30 fade</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-48" href="#Examples-48">28.30.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fftfilt" href="#fftfilt">28.31 fftfilt</a></li>
    <li><a name="toc-field" href="#field">28.32 field</a></li>
    <li><a name="toc-fieldmatch" href="#fieldmatch">28.33 fieldmatch</a>
    <ul class="no-bullet">
      <li><a name="toc-p_002fc_002fn_002fu_002fb-meaning-1" href="#p_002fc_002fn_002fu_002fb-meaning-1">28.33.1 p/c/n/u/b meaning</a>
      <ul class="no-bullet">
        <li><a name="toc-p_002fc_002fn" href="#p_002fc_002fn">28.33.1.1 p/c/n</a></li>
        <li><a name="toc-u_002fb" href="#u_002fb">28.33.1.2 u/b</a></li>
      </ul></li>
      <li><a name="toc-Examples-49" href="#Examples-49">28.33.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-fieldorder" href="#fieldorder">28.34 fieldorder</a></li>
    <li><a name="toc-fifo" href="#fifo">28.35 fifo</a></li>
    <li><a name="toc-format-1" href="#format-1">28.36 format</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-50" href="#Examples-50">28.36.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fps-1" href="#fps-1">28.37 fps</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-51" href="#Examples-51">28.37.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-framepack" href="#framepack">28.38 framepack</a></li>
    <li><a name="toc-framestep" href="#framestep">28.39 framestep</a></li>
    <li><a name="toc-frei0r-1" href="#frei0r-1">28.40 frei0r</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-52" href="#Examples-52">28.40.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-fspp" href="#fspp">28.41 fspp</a></li>
    <li><a name="toc-geq" href="#geq">28.42 geq</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-53" href="#Examples-53">28.42.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-gradfun" href="#gradfun">28.43 gradfun</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-54" href="#Examples-54">28.43.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-haldclut-1" href="#haldclut-1">28.44 haldclut</a>
    <ul class="no-bullet">
      <li><a name="toc-Workflow-examples" href="#Workflow-examples">28.44.1 Workflow examples</a>
      <ul class="no-bullet">
        <li><a name="toc-Hald-CLUT-video-stream" href="#Hald-CLUT-video-stream">28.44.1.1 Hald CLUT video stream</a></li>
        <li><a name="toc-Hald-CLUT-with-preview" href="#Hald-CLUT-with-preview">28.44.1.2 Hald CLUT with preview</a></li>
      </ul></li>
    </ul></li>
    <li><a name="toc-hflip" href="#hflip">28.45 hflip</a></li>
    <li><a name="toc-histeq" href="#histeq">28.46 histeq</a></li>
    <li><a name="toc-histogram" href="#histogram">28.47 histogram</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-55" href="#Examples-55">28.47.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-hqdn3d-1" href="#hqdn3d-1">28.48 hqdn3d</a></li>
    <li><a name="toc-hqx" href="#hqx">28.49 hqx</a></li>
    <li><a name="toc-hue" href="#hue">28.50 hue</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-56" href="#Examples-56">28.50.1 Examples</a></li>
      <li><a name="toc-Commands-3" href="#Commands-3">28.50.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-idet" href="#idet">28.51 idet</a></li>
    <li><a name="toc-il" href="#il">28.52 il</a></li>
    <li><a name="toc-interlace" href="#interlace">28.53 interlace</a></li>
    <li><a name="toc-kerndeint" href="#kerndeint">28.54 kerndeint</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-57" href="#Examples-57">28.54.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-lenscorrection" href="#lenscorrection">28.55 lenscorrection</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-17" href="#Options-17">28.55.1 Options</a></li>
    </ul></li>
    <li><a name="toc-lut3d-1" href="#lut3d-1">28.56 lut3d</a></li>
    <li><a name="toc-lut_002c-lutrgb_002c-lutyuv" href="#lut_002c-lutrgb_002c-lutyuv">28.57 lut, lutrgb, lutyuv</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-58" href="#Examples-58">28.57.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-mergeplanes" href="#mergeplanes">28.58 mergeplanes</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-59" href="#Examples-59">28.58.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-mcdeint" href="#mcdeint">28.59 mcdeint</a></li>
    <li><a name="toc-mpdecimate" href="#mpdecimate">28.60 mpdecimate</a></li>
    <li><a name="toc-negate" href="#negate">28.61 negate</a></li>
    <li><a name="toc-noformat" href="#noformat">28.62 noformat</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-60" href="#Examples-60">28.62.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-noise-1" href="#noise-1">28.63 noise</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-61" href="#Examples-61">28.63.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-null" href="#null">28.64 null</a></li>
    <li><a name="toc-ocv" href="#ocv">28.65 ocv</a>
    <ul class="no-bullet">
      <li><a name="toc-dilate-1" href="#dilate-1">28.65.1 dilate</a></li>
      <li><a name="toc-erode" href="#erode">28.65.2 erode</a></li>
      <li><a name="toc-smooth" href="#smooth">28.65.3 smooth</a></li>
    </ul></li>
    <li><a name="toc-overlay-1" href="#overlay-1">28.66 overlay</a>
    <ul class="no-bullet">
      <li><a name="toc-Commands-4" href="#Commands-4">28.66.1 Commands</a></li>
      <li><a name="toc-Examples-62" href="#Examples-62">28.66.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-owdenoise" href="#owdenoise">28.67 owdenoise</a></li>
    <li><a name="toc-pad" href="#pad">28.68 pad</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-63" href="#Examples-63">28.68.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-palettegen-1" href="#palettegen-1">28.69 palettegen</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-64" href="#Examples-64">28.69.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-paletteuse" href="#paletteuse">28.70 paletteuse</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-65" href="#Examples-65">28.70.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-perspective" href="#perspective">28.71 perspective</a></li>
    <li><a name="toc-phase" href="#phase">28.72 phase</a></li>
    <li><a name="toc-pixdesctest" href="#pixdesctest">28.73 pixdesctest</a></li>
    <li><a name="toc-pp" href="#pp">28.74 pp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-66" href="#Examples-66">28.74.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-pp7" href="#pp7">28.75 pp7</a></li>
    <li><a name="toc-psnr" href="#psnr">28.76 psnr</a></li>
    <li><a name="toc-pullup-1" href="#pullup-1">28.77 pullup</a></li>
    <li><a name="toc-qp" href="#qp">28.78 qp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-67" href="#Examples-67">28.78.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-removelogo" href="#removelogo">28.79 removelogo</a></li>
    <li><a name="toc-repeatfields" href="#repeatfields">28.80 repeatfields</a></li>
    <li><a name="toc-rotate" href="#rotate">28.81 rotate</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-68" href="#Examples-68">28.81.1 Examples</a></li>
      <li><a name="toc-Commands-5" href="#Commands-5">28.81.2 Commands</a></li>
    </ul></li>
    <li><a name="toc-sab" href="#sab">28.82 sab</a></li>
    <li><a name="toc-scale-1" href="#scale-1">28.83 scale</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-18" href="#Options-18">28.83.1 Options</a></li>
      <li><a name="toc-Examples-69" href="#Examples-69">28.83.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-separatefields" href="#separatefields">28.84 separatefields</a></li>
    <li><a name="toc-setdar_002c-setsar" href="#setdar_002c-setsar">28.85 setdar, setsar</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-70" href="#Examples-70">28.85.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-setfield-1" href="#setfield-1">28.86 setfield</a></li>
    <li><a name="toc-showinfo" href="#showinfo">28.87 showinfo</a></li>
    <li><a name="toc-showpalette" href="#showpalette">28.88 showpalette</a></li>
    <li><a name="toc-shuffleplanes" href="#shuffleplanes">28.89 shuffleplanes</a></li>
    <li><a name="toc-signalstats" href="#signalstats">28.90 signalstats</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-71" href="#Examples-71">28.90.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-smartblur-1" href="#smartblur-1">28.91 smartblur</a></li>
    <li><a name="toc-stereo3d" href="#stereo3d">28.92 stereo3d</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-72" href="#Examples-72">28.92.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-spp-1" href="#spp-1">28.93 spp</a></li>
    <li><a name="toc-subtitles-1" href="#subtitles-1">28.94 subtitles</a></li>
    <li><a name="toc-super2xsai" href="#super2xsai">28.95 super2xsai</a></li>
    <li><a name="toc-swapuv" href="#swapuv">28.96 swapuv</a></li>
    <li><a name="toc-telecine" href="#telecine">28.97 telecine</a></li>
    <li><a name="toc-thumbnail" href="#thumbnail">28.98 thumbnail</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-73" href="#Examples-73">28.98.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-tile" href="#tile">28.99 tile</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-74" href="#Examples-74">28.99.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-tinterlace" href="#tinterlace">28.100 tinterlace</a></li>
    <li><a name="toc-transpose" href="#transpose">28.101 transpose</a></li>
    <li><a name="toc-trim" href="#trim">28.102 trim</a></li>
    <li><a name="toc-unsharp-1" href="#unsharp-1">28.103 unsharp</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-75" href="#Examples-75">28.103.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-uspp" href="#uspp">28.104 uspp</a></li>
    <li><a name="toc-vidstabdetect-1" href="#vidstabdetect-1">28.105 vidstabdetect</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-76" href="#Examples-76">28.105.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-vidstabtransform-1" href="#vidstabtransform-1">28.106 vidstabtransform</a>
    <ul class="no-bullet">
      <li><a name="toc-Options-19" href="#Options-19">28.106.1 Options</a></li>
      <li><a name="toc-Examples-77" href="#Examples-77">28.106.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-vflip" href="#vflip">28.107 vflip</a></li>
    <li><a name="toc-vignette-1" href="#vignette-1">28.108 vignette</a>
    <ul class="no-bullet">
      <li><a name="toc-Expressions" href="#Expressions">28.108.1 Expressions</a></li>
      <li><a name="toc-Examples-78" href="#Examples-78">28.108.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-w3fdif" href="#w3fdif">28.109 w3fdif</a></li>
    <li><a name="toc-xbr" href="#xbr">28.110 xbr</a></li>
    <li><a name="toc-yadif-1" href="#yadif-1">28.111 yadif</a></li>
    <li><a name="toc-zoompan" href="#zoompan">28.112 zoompan</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-79" href="#Examples-79">28.112.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-80" href="#Examples-80">29.2.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-81" href="#Examples-81">29.6.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Commands-6" href="#Commands-6">29.7.1 Commands</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-82" href="#Examples-82">31.1.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-concat-3" href="#concat-3">31.2 concat</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-83" href="#Examples-83">31.2.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-86" href="#Examples-86">31.6.1 Examples</a></li>
    </ul></li>
    ...
    <ul class="no-bullet">
      ...
      <li><a name="toc-Examples-87" href="#Examples-87">31.7.2 Examples</a></li>
    </ul></li>
    <li><a name="toc-setpts_002c-asetpts" href="#setpts_002c-asetpts">31.8 setpts, asetpts</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-88" href="#Examples-88">31.8.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-settb_002c-asettb" href="#settb_002c-asettb">31.9 settb, asettb</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-89" href="#Examples-89">31.9.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showcqt" href="#showcqt">31.10 showcqt</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-90" href="#Examples-90">31.10.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showspectrum" href="#showspectrum">31.11 showspectrum</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-91" href="#Examples-91">31.11.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-showwaves" href="#showwaves">31.12 showwaves</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-92" href="#Examples-92">31.12.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-split_002c-asplit" href="#split_002c-asplit">31.13 split, asplit</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-93" href="#Examples-93">31.13.1 Examples</a></li>
    </ul></li>
    <li><a name="toc-zmq_002c-azmq" href="#zmq_002c-azmq">31.14 zmq, azmq</a>
    <ul class="no-bullet">
      <li><a name="toc-Examples-94" href="#Examples-94">31.14.1 Examples</a></li>
    </ul></li>
  </ul></li>
  ...
  <ul class="no-bullet">
    ...
    <ul class="no-bullet">
      <li><a name="toc-Examples-95" href="#Examples-95">32.2.1 Examples</a></li>
    </ul></li>
  </ul></li>
...
<a name="Syntax"></a>
<h2 class="chapter">4 Syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Syntax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Syntax" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">4.1 Quoting and escaping<span class="pull-right"><a class="anchor hidden-xs" href="#Quoting-and-escaping" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Quoting-and-escaping" aria-hidden="true">TOC</a></span></h3>

<p>FFmpeg adopts the following quoting and escaping mechanism, unless
explicitly specified. The following rules are applied:
</p>
<ul>
<li> <code>'</code> and <code>\</code> are special characters (respectively used for
quoting and escaping). In addition to them, there might be other
special characters depending on the specific syntax where the escaping
and quoting are employed.

</li><li> A special character is escaped by prefixing it with a &rsquo;\&rsquo;.

</li><li> All characters enclosed between &rdquo; are included literally in the
...
<a name="Examples"></a>
<h4 class="subsection">4.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples" aria-hidden="true">TOC</a></span></h4>
...
</li><li> To include a literal <code>\</code> you can use either escaping or quoting:
<div class="example">
...
<h3 class="section">4.2 Date<span class="pull-right"><a class="anchor hidden-xs" href="#Date" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Date" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.3 Time duration<span class="pull-right"><a class="anchor hidden-xs" href="#Time-duration" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Time-duration" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-1"></a>
<h4 class="subsection">4.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-1" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">4.4 Video size<span class="pull-right"><a class="anchor hidden-xs" href="#Video-size" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-size" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.5 Video rate<span class="pull-right"><a class="anchor hidden-xs" href="#Video-rate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-rate" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.6 Ratio<span class="pull-right"><a class="anchor hidden-xs" href="#Ratio" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Ratio" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.7 Color<span class="pull-right"><a class="anchor hidden-xs" href="#Color" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Color" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">4.8 Channel Layout<span class="pull-right"><a class="anchor hidden-xs" href="#Channel-Layout" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Channel-Layout" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">5 Expression Evaluation<span class="pull-right"><a class="anchor hidden-xs" href="#Expression-Evaluation" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Expression-Evaluation" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">6 OpenCL Options<span class="pull-right"><a class="anchor hidden-xs" href="#OpenCL-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-OpenCL-Options" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">7 Codec Options<span class="pull-right"><a class="anchor hidden-xs" href="#Codec-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Codec-Options" aria-hidden="true">TOC</a></span></h2>
...
<a name="Decoders"></a>
<h2 class="chapter">8 Decoders<span class="pull-right"><a class="anchor hidden-xs" href="#Decoders" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Decoders" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">9 Video Decoders<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Decoders" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Decoders" aria-hidden="true">TOC</a></span></h2>

<p>A description of some of the currently available video decoders
follows.
</p>
<a name="rawvideo"></a>
<h3 class="section">9.1 rawvideo<span class="pull-right"><a class="anchor hidden-xs" href="#rawvideo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rawvideo" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-1"></a>
<h4 class="subsection">9.1.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-1" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">10 Audio Decoders<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Decoders" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Decoders" aria-hidden="true">TOC</a></span></h2>

<p>A description of some of the currently available audio decoders
follows.
</p>
<a name="ac3"></a>
<h3 class="section">10.1 ac3<span class="pull-right"><a class="anchor hidden-xs" href="#ac3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ac3" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">10.1.1 AC-3 Decoder Options<span class="pull-right"><a class="anchor hidden-xs" href="#AC_002d3-Decoder-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-AC_002d3-Decoder-Options" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">10.2 ffwavesynth<span class="pull-right"><a class="anchor hidden-xs" href="#ffwavesynth" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ffwavesynth" aria-hidden="true">TOC</a></span></h3>
...
<a name="libcelt"></a>
<h3 class="section">10.3 libcelt<span class="pull-right"><a class="anchor hidden-xs" href="#libcelt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libcelt" aria-hidden="true">TOC</a></span></h3>
...
<a name="libgsm"></a>
<h3 class="section">10.4 libgsm<span class="pull-right"><a class="anchor hidden-xs" href="#libgsm" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libgsm" aria-hidden="true">TOC</a></span></h3>
...
<a name="libilbc"></a>
<h3 class="section">10.5 libilbc<span class="pull-right"><a class="anchor hidden-xs" href="#libilbc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libilbc" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-2"></a>
<h4 class="subsection">10.5.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-2" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">10.6 libopencore-amrnb<span class="pull-right"><a class="anchor hidden-xs" href="#libopencore_002damrnb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libopencore_002damrnb" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">10.7 libopencore-amrwb<span class="pull-right"><a class="anchor hidden-xs" href="#libopencore_002damrwb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libopencore_002damrwb" aria-hidden="true">TOC</a></span></h3>
...
<a name="libopus"></a>
<h3 class="section">10.8 libopus<span class="pull-right"><a class="anchor hidden-xs" href="#libopus" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libopus" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">11 Subtitles Decoders<span class="pull-right"><a class="anchor hidden-xs" href="#Subtitles-Decoders" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Subtitles-Decoders" aria-hidden="true">TOC</a></span></h2>

<a name="dvdsub"></a>
<h3 class="section">11.1 dvdsub<span class="pull-right"><a class="anchor hidden-xs" href="#dvdsub" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dvdsub" aria-hidden="true">TOC</a></span></h3>

<p>This codec decodes the bitmap subtitles used in DVDs; the same subtitles can
also be found in VobSub file pairs and in some Matroska files.
</p>
<a name="Options-3"></a>
<h4 class="subsection">11.1.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-3" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">11.2 libzvbi-teletext<span class="pull-right"><a class="anchor hidden-xs" href="#libzvbi_002dteletext" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libzvbi_002dteletext" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-4"></a>
<h4 class="subsection">11.2.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-4" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-4" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">12 Bitstream Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Bitstream-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Bitstream-Filters" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">12.1 aac_adtstoasc<span class="pull-right"><a class="anchor hidden-xs" href="#aac_005fadtstoasc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aac_005fadtstoasc" aria-hidden="true">TOC</a></span></h3>
...
<a name="chomp"></a>
<h3 class="section">12.2 chomp<span class="pull-right"><a class="anchor hidden-xs" href="#chomp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-chomp" aria-hidden="true">TOC</a></span></h3>

<p>Remove zero padding at the end of a packet.
</p>
<a name="dump_005fextra"></a>
<h3 class="section">12.3 dump_extra<span class="pull-right"><a class="anchor hidden-xs" href="#dump_005fextra" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dump_005fextra" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">12.4 h264_mp4toannexb<span class="pull-right"><a class="anchor hidden-xs" href="#h264_005fmp4toannexb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-h264_005fmp4toannexb" aria-hidden="true">TOC</a></span></h3>
...
<a name="imxdump"></a>
<h3 class="section">12.5 imxdump<span class="pull-right"><a class="anchor hidden-xs" href="#imxdump" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-imxdump" aria-hidden="true">TOC</a></span></h3>
...
<a name="mjpeg2jpeg"></a>
<h3 class="section">12.6 mjpeg2jpeg<span class="pull-right"><a class="anchor hidden-xs" href="#mjpeg2jpeg" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mjpeg2jpeg" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">12.7 mjpega_dump_header<span class="pull-right"><a class="anchor hidden-xs" href="#mjpega_005fdump_005fheader" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mjpega_005fdump_005fheader" aria-hidden="true">TOC</a></span></h3>

<a name="movsub"></a>
<h3 class="section">12.8 movsub<span class="pull-right"><a class="anchor hidden-xs" href="#movsub" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-movsub" aria-hidden="true">TOC</a></span></h3>

<a name="mp3_005fheader_005fdecompress"></a>
<h3 class="section">12.9 mp3_header_decompress<span class="pull-right"><a class="anchor hidden-xs" href="#mp3_005fheader_005fdecompress" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mp3_005fheader_005fdecompress" aria-hidden="true">TOC</a></span></h3>

<a name="noise"></a>
<h3 class="section">12.10 noise<span class="pull-right"><a class="anchor hidden-xs" href="#noise" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-noise" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">12.11 remove_extra<span class="pull-right"><a class="anchor hidden-xs" href="#remove_005fextra" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-remove_005fextra" aria-hidden="true">TOC</a></span></h3>

<a name="Format-Options"></a>
<h2 class="chapter">13 Format Options<span class="pull-right"><a class="anchor hidden-xs" href="#Format-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Format-Options" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">13.1 Format stream specifiers<span class="pull-right"><a class="anchor hidden-xs" href="#Format-stream-specifiers-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Format-stream-specifiers-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Demuxers"></a>
<h2 class="chapter">14 Demuxers<span class="pull-right"><a class="anchor hidden-xs" href="#Demuxers" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Demuxers" aria-hidden="true">TOC</a></span></h2>
...
<a name="applehttp"></a>
<h3 class="section">14.1 applehttp<span class="pull-right"><a class="anchor hidden-xs" href="#applehttp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-applehttp" aria-hidden="true">TOC</a></span></h3>
...
<a name="apng"></a>
<h3 class="section">14.2 apng<span class="pull-right"><a class="anchor hidden-xs" href="#apng" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-apng" aria-hidden="true">TOC</a></span></h3>
...
<a name="asf"></a>
<h3 class="section">14.3 asf<span class="pull-right"><a class="anchor hidden-xs" href="#asf" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asf" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">14.4 concat<span class="pull-right"><a class="anchor hidden-xs" href="#concat-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-concat-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Syntax-1"></a>
<h4 class="subsection">14.4.1 Syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Syntax-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Syntax-1" aria-hidden="true">TOC</a></span></h4>
...
<a name="Options-5"></a>
<h4 class="subsection">14.4.2 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-5" aria-hidden="true">TOC</a></span></h4>
...
<a name="flv"></a>
<h3 class="section">14.5 flv<span class="pull-right"><a class="anchor hidden-xs" href="#flv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-flv" aria-hidden="true">TOC</a></span></h3>
...
<a name="libgme"></a>
<h3 class="section">14.6 libgme<span class="pull-right"><a class="anchor hidden-xs" href="#libgme" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libgme" aria-hidden="true">TOC</a></span></h3>
...
<a name="libquvi"></a>
<h3 class="section">14.7 libquvi<span class="pull-right"><a class="anchor hidden-xs" href="#libquvi" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libquvi" aria-hidden="true">TOC</a></span></h3>
...
<a name="gif"></a>
<h3 class="section">14.8 gif<span class="pull-right"><a class="anchor hidden-xs" href="#gif" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-gif" aria-hidden="true">TOC</a></span></h3>
...
<a name="image2"></a>
<h3 class="section">14.9 image2<span class="pull-right"><a class="anchor hidden-xs" href="#image2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-image2" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-2"></a>
<h4 class="subsection">14.9.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-2" aria-hidden="true">TOC</a></span></h4>
...
<a name="mpegts"></a>
<h3 class="section">14.10 mpegts<span class="pull-right"><a class="anchor hidden-xs" href="#mpegts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mpegts" aria-hidden="true">TOC</a></span></h3>
...
<a name="rawvideo-1"></a>
<h3 class="section">14.11 rawvideo<span class="pull-right"><a class="anchor hidden-xs" href="#rawvideo-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rawvideo-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="sbg"></a>
<h3 class="section">14.12 sbg<span class="pull-right"><a class="anchor hidden-xs" href="#sbg" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sbg" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">14.13 tedcaptions<span class="pull-right"><a class="anchor hidden-xs" href="#tedcaptions" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tedcaptions" aria-hidden="true">TOC</a></span></h3>
...
<a name="Metadata"></a>
<h2 class="chapter">15 Metadata<span class="pull-right"><a class="anchor hidden-xs" href="#Metadata" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Metadata" aria-hidden="true">TOC</a></span></h2>
...
</li><li> The header is a &rsquo;;FFMETADATA&rsquo; string, followed by a version number (now 1).

</li><li> Metadata tags are of the form &rsquo;key=value&rsquo;
...
</li><li> Empty lines and lines starting with &rsquo;;&rsquo; or &rsquo;#&rsquo; are ignored.

</li><li> Metadata keys or values containing special characters (&rsquo;=&rsquo;, &rsquo;;&rsquo;, &rsquo;#&rsquo;, &rsquo;\&rsquo; and a
newline) must be escaped with a backslash &rsquo;\&rsquo;.

</li><li> Note that whitespace in metadata (e.g. foo = bar) is considered to be a part of
...
<a name="Protocols"></a>
<h2 class="chapter">16 Protocols<span class="pull-right"><a class="anchor hidden-xs" href="#Protocols" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Protocols" aria-hidden="true">TOC</a></span></h2>
...
<a name="bluray"></a>
<h3 class="section">16.1 bluray<span class="pull-right"><a class="anchor hidden-xs" href="#bluray" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bluray" aria-hidden="true">TOC</a></span></h3>
...
<a name="cache"></a>
<h3 class="section">16.2 cache<span class="pull-right"><a class="anchor hidden-xs" href="#cache" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-cache" aria-hidden="true">TOC</a></span></h3>
...
<a name="concat-2"></a>
<h3 class="section">16.3 concat<span class="pull-right"><a class="anchor hidden-xs" href="#concat-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-concat-2" aria-hidden="true">TOC</a></span></h3>
...
<a name="crypto"></a>
<h3 class="section">16.4 crypto<span class="pull-right"><a class="anchor hidden-xs" href="#crypto" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-crypto" aria-hidden="true">TOC</a></span></h3>
...
<a name="data"></a>
<h3 class="section">16.5 data<span class="pull-right"><a class="anchor hidden-xs" href="#data" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-data" aria-hidden="true">TOC</a></span></h3>
...
<a name="file"></a>
<h3 class="section">16.6 file<span class="pull-right"><a class="anchor hidden-xs" href="#file" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-file" aria-hidden="true">TOC</a></span></h3>
...
<a name="ftp"></a>
<h3 class="section">16.7 ftp<span class="pull-right"><a class="anchor hidden-xs" href="#ftp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ftp" aria-hidden="true">TOC</a></span></h3>
...
<a name="gopher"></a>
<h3 class="section">16.8 gopher<span class="pull-right"><a class="anchor hidden-xs" href="#gopher" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-gopher" aria-hidden="true">TOC</a></span></h3>

<p>Gopher protocol.
</p>
<a name="hls"></a>
<h3 class="section">16.9 hls<span class="pull-right"><a class="anchor hidden-xs" href="#hls" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hls" aria-hidden="true">TOC</a></span></h3>
...
<a name="http"></a>
<h3 class="section">16.10 http<span class="pull-right"><a class="anchor hidden-xs" href="#http" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-http" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">16.10.1 HTTP Cookies<span class="pull-right"><a class="anchor hidden-xs" href="#HTTP-Cookies" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-HTTP-Cookies" aria-hidden="true">TOC</a></span></h4>
...
<a name="Icecast"></a>
<h3 class="section">16.11 Icecast<span class="pull-right"><a class="anchor hidden-xs" href="#Icecast" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Icecast" aria-hidden="true">TOC</a></span></h3>
...
<a name="mmst"></a>
<h3 class="section">16.12 mmst<span class="pull-right"><a class="anchor hidden-xs" href="#mmst" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mmst" aria-hidden="true">TOC</a></span></h3>

<p>MMS (Microsoft Media Server) protocol over TCP.
</p>
<a name="mmsh"></a>
<h3 class="section">16.13 mmsh<span class="pull-right"><a class="anchor hidden-xs" href="#mmsh" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mmsh" aria-hidden="true">TOC</a></span></h3>
...
<a name="md5"></a>
<h3 class="section">16.14 md5<span class="pull-right"><a class="anchor hidden-xs" href="#md5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-md5" aria-hidden="true">TOC</a></span></h3>
...
<a name="pipe"></a>
<h3 class="section">16.15 pipe<span class="pull-right"><a class="anchor hidden-xs" href="#pipe" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pipe" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmp"></a>
<h3 class="section">16.16 rtmp<span class="pull-right"><a class="anchor hidden-xs" href="#rtmp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmp" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmpe"></a>
<h3 class="section">16.17 rtmpe<span class="pull-right"><a class="anchor hidden-xs" href="#rtmpe" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmpe" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmps"></a>
<h3 class="section">16.18 rtmps<span class="pull-right"><a class="anchor hidden-xs" href="#rtmps" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmps" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmpt"></a>
<h3 class="section">16.19 rtmpt<span class="pull-right"><a class="anchor hidden-xs" href="#rtmpt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmpt" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmpte"></a>
<h3 class="section">16.20 rtmpte<span class="pull-right"><a class="anchor hidden-xs" href="#rtmpte" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmpte" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtmpts"></a>
<h3 class="section">16.21 rtmpts<span class="pull-right"><a class="anchor hidden-xs" href="#rtmpts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtmpts" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">16.22 libsmbclient<span class="pull-right"><a class="anchor hidden-xs" href="#libsmbclient" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libsmbclient" aria-hidden="true">TOC</a></span></h3>
...
<a name="libssh"></a>
<h3 class="section">16.23 libssh<span class="pull-right"><a class="anchor hidden-xs" href="#libssh" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-libssh" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">16.24 librtmp rtmp, rtmpe, rtmps, rtmpt, rtmpte<span class="pull-right"><a class="anchor hidden-xs" href="#librtmp-rtmp_002c-rtmpe_002c-rtmps_002c-rtmpt_002c-rtmpte" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-librtmp-rtmp_002c-rtmpe_002c-rtmps_002c-rtmpt_002c-rtmpte" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtp"></a>
<h3 class="section">16.25 rtp<span class="pull-right"><a class="anchor hidden-xs" href="#rtp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtp" aria-hidden="true">TOC</a></span></h3>
...
<a name="rtsp"></a>
<h3 class="section">16.26 rtsp<span class="pull-right"><a class="anchor hidden-xs" href="#rtsp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rtsp" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-3"></a>
<h4 class="subsection">16.26.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-3" aria-hidden="true">TOC</a></span></h4>
...
<a name="sap"></a>
<h3 class="section">16.27 sap<span class="pull-right"><a class="anchor hidden-xs" href="#sap" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sap" aria-hidden="true">TOC</a></span></h3>
...
<a name="Muxer"></a>
<h4 class="subsection">16.27.1 Muxer<span class="pull-right"><a class="anchor hidden-xs" href="#Muxer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Muxer" aria-hidden="true">TOC</a></span></h4>
...
<a name="Demuxer"></a>
<h4 class="subsection">16.27.2 Demuxer<span class="pull-right"><a class="anchor hidden-xs" href="#Demuxer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Demuxer" aria-hidden="true">TOC</a></span></h4>
...
<a name="sctp"></a>
<h3 class="section">16.28 sctp<span class="pull-right"><a class="anchor hidden-xs" href="#sctp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sctp" aria-hidden="true">TOC</a></span></h3>
...
<a name="srtp"></a>
<h3 class="section">16.29 srtp<span class="pull-right"><a class="anchor hidden-xs" href="#srtp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-srtp" aria-hidden="true">TOC</a></span></h3>
...
<a name="subfile"></a>
<h3 class="section">16.30 subfile<span class="pull-right"><a class="anchor hidden-xs" href="#subfile" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-subfile" aria-hidden="true">TOC</a></span></h3>
...
<a name="tcp"></a>
<h3 class="section">16.31 tcp<span class="pull-right"><a class="anchor hidden-xs" href="#tcp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tcp" aria-hidden="true">TOC</a></span></h3>
...
<a name="tls"></a>
<h3 class="section">16.32 tls<span class="pull-right"><a class="anchor hidden-xs" href="#tls" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tls" aria-hidden="true">TOC</a></span></h3>
...
<a name="udp"></a>
<h3 class="section">16.33 udp<span class="pull-right"><a class="anchor hidden-xs" href="#udp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-udp" aria-hidden="true">TOC</a></span></h3>
...
<a name="Examples-4"></a>
<h4 class="subsection">16.33.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-4" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-4" aria-hidden="true">TOC</a></span></h4>
...
<a name="unix"></a>
<h3 class="section">16.34 unix<span class="pull-right"><a class="anchor hidden-xs" href="#unix" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-unix" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">17 Device Options<span class="pull-right"><a class="anchor hidden-xs" href="#Device-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Device-Options" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">18 Input Devices<span class="pull-right"><a class="anchor hidden-xs" href="#Input-Devices" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Input-Devices" aria-hidden="true">TOC</a></span></h2>
...
<a name="alsa"></a>
<h3 class="section">18.1 alsa<span class="pull-right"><a class="anchor hidden-xs" href="#alsa" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-alsa" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">18.2 avfoundation<span class="pull-right"><a class="anchor hidden-xs" href="#avfoundation" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-avfoundation" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-6"></a>
<h4 class="subsection">18.2.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-6" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-6" aria-hidden="true">TOC</a></span></h4>
...
<a name="Examples-5"></a>
<h4 class="subsection">18.2.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-5" aria-hidden="true">TOC</a></span></h4>
...
<a name="bktr"></a>
<h3 class="section">18.3 bktr<span class="pull-right"><a class="anchor hidden-xs" href="#bktr" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bktr" aria-hidden="true">TOC</a></span></h3>
...
<pre class="example">ffmpeg -f fbdev -r 10 -i /dev/fb0 out.avi
</pre></div>

<p>You can take a single screenshot image with the command:
</p><div class="example">
<pre class="example">ffmpeg -f fbdev -frames:v 1 -r 1 -i /dev/fb0 screenshot.jpeg
</pre></div>
...
<a name="qtkit"></a>
<h3 class="section">18.16 qtkit<span class="pull-right"><a class="anchor hidden-xs" href="#qtkit" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-qtkit" aria-hidden="true">TOC</a></span></h3>
...
<a name="sndio"></a>
<h3 class="section">18.17 sndio<span class="pull-right"><a class="anchor hidden-xs" href="#sndio" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sndio" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">18.18 video4linux2, v4l2<span class="pull-right"><a class="anchor hidden-xs" href="#video4linux2_002c-v4l2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-video4linux2_002c-v4l2" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-14"></a>
<h4 class="subsection">18.18.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-14" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-14" aria-hidden="true">TOC</a></span></h4>
...
<a name="vfwcap"></a>
<h3 class="section">18.19 vfwcap<span class="pull-right"><a class="anchor hidden-xs" href="#vfwcap" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vfwcap" aria-hidden="true">TOC</a></span></h3>
...
<a name="x11grab"></a>
<h3 class="section">18.20 x11grab<span class="pull-right"><a class="anchor hidden-xs" href="#x11grab" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-x11grab" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-15"></a>
<h4 class="subsection">18.20.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-15" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-15" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">18.20.2 <var>grab_x</var> <var>grab_y</var> AVOption<span class="pull-right"><a class="anchor hidden-xs" href="#grab_005fx-grab_005fy-AVOption" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-grab_005fx-grab_005fy-AVOption" aria-hidden="true">TOC</a></span></h4>
...
<a name="decklink"></a>
<h3 class="section">18.21 decklink<span class="pull-right"><a class="anchor hidden-xs" href="#decklink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-decklink" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-16"></a>
<h4 class="subsection">18.21.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-16" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-16" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">18.21.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-11" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-11" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">19 Resampler Options<span class="pull-right"><a class="anchor hidden-xs" href="#Resampler-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Resampler-Options" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">20 Scaler Options<span class="pull-right"><a class="anchor hidden-xs" href="#Scaler-Options" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Scaler-Options" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">21 Filtering Introduction<span class="pull-right"><a class="anchor hidden-xs" href="#Filtering-Introduction" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtering-Introduction" aria-hidden="true">TOC</a></span></h2>
...
<a name="graph2dot"></a>
<h2 class="chapter">22 graph2dot<span class="pull-right"><a class="anchor hidden-xs" href="#graph2dot" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-graph2dot" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">23 Filtergraph description<span class="pull-right"><a class="anchor hidden-xs" href="#Filtergraph-description" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtergraph-description" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">23.1 Filtergraph syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Filtergraph-syntax-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Filtergraph-syntax-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">23.2 Notes on filtergraph escaping<span class="pull-right"><a class="anchor hidden-xs" href="#Notes-on-filtergraph-escaping" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Notes-on-filtergraph-escaping" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">24 Timeline editing<span class="pull-right"><a class="anchor hidden-xs" href="#Timeline-editing" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Timeline-editing" aria-hidden="true">TOC</a></span></h2>
...
<h2 class="chapter">25 Audio Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Filters" aria-hidden="true">TOC</a></span></h2>
...
<a name="adelay"></a>
<h3 class="section">25.1 adelay<span class="pull-right"><a class="anchor hidden-xs" href="#adelay" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-adelay" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-12" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-12" aria-hidden="true">TOC</a></span></h4>
...
<a name="aecho"></a>
<h3 class="section">25.2 aecho<span class="pull-right"><a class="anchor hidden-xs" href="#aecho" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aecho" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-13" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-13" aria-hidden="true">TOC</a></span></h4>
...
<a name="aeval"></a>
<h3 class="section">25.3 aeval<span class="pull-right"><a class="anchor hidden-xs" href="#aeval" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aeval" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-14" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-14" aria-hidden="true">TOC</a></span></h4>
...
<a name="afade"></a>
<h3 class="section">25.4 afade<span class="pull-right"><a class="anchor hidden-xs" href="#afade" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-afade" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-15" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-15" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">25.5 aformat<span class="pull-right"><a class="anchor hidden-xs" href="#aformat-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aformat-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="allpass"></a>
<h3 class="section">25.6 allpass<span class="pull-right"><a class="anchor hidden-xs" href="#allpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-allpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="amerge"></a>
<h3 class="section">25.7 amerge<span class="pull-right"><a class="anchor hidden-xs" href="#amerge" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amerge" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.7.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-16" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-16" aria-hidden="true">TOC</a></span></h4>
...
<a name="amix"></a>
<h3 class="section">25.8 amix<span class="pull-right"><a class="anchor hidden-xs" href="#amix" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amix" aria-hidden="true">TOC</a></span></h3>
...
<a name="anull"></a>
<h3 class="section">25.9 anull<span class="pull-right"><a class="anchor hidden-xs" href="#anull" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anull" aria-hidden="true">TOC</a></span></h3>

<p>Pass the audio source unchanged to the output.
</p>
<a name="apad"></a>
<h3 class="section">25.10 apad<span class="pull-right"><a class="anchor hidden-xs" href="#apad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-apad" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-17" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-17" aria-hidden="true">TOC</a></span></h4>
...
<a name="aphaser"></a>
<h3 class="section">25.11 aphaser<span class="pull-right"><a class="anchor hidden-xs" href="#aphaser" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aphaser" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">25.12 aresample<span class="pull-right"><a class="anchor hidden-xs" href="#aresample-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aresample-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-18" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-18" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">25.13 asetnsamples<span class="pull-right"><a class="anchor hidden-xs" href="#asetnsamples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asetnsamples" aria-hidden="true">TOC</a></span></h3>
...
<a name="asetrate"></a>
<h3 class="section">25.14 asetrate<span class="pull-right"><a class="anchor hidden-xs" href="#asetrate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asetrate" aria-hidden="true">TOC</a></span></h3>
...
<a name="ashowinfo"></a>
<h3 class="section">25.15 ashowinfo<span class="pull-right"><a class="anchor hidden-xs" href="#ashowinfo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ashowinfo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">25.16 astats<span class="pull-right"><a class="anchor hidden-xs" href="#astats-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-astats-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">25.17 astreamsync<span class="pull-right"><a class="anchor hidden-xs" href="#astreamsync" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-astreamsync" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.17.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-19" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-19" aria-hidden="true">TOC</a></span></h4>
...
<a name="asyncts"></a>
<h3 class="section">25.18 asyncts<span class="pull-right"><a class="anchor hidden-xs" href="#asyncts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-asyncts" aria-hidden="true">TOC</a></span></h3>
...
<a name="atempo"></a>
<h3 class="section">25.19 atempo<span class="pull-right"><a class="anchor hidden-xs" href="#atempo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-atempo" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.19.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-20" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-20" aria-hidden="true">TOC</a></span></h4>
...
<a name="atrim"></a>
<h3 class="section">25.20 atrim<span class="pull-right"><a class="anchor hidden-xs" href="#atrim" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-atrim" aria-hidden="true">TOC</a></span></h3>
...
<a name="bandpass"></a>
<h3 class="section">25.21 bandpass<span class="pull-right"><a class="anchor hidden-xs" href="#bandpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bandpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="bandreject"></a>
<h3 class="section">25.22 bandreject<span class="pull-right"><a class="anchor hidden-xs" href="#bandreject" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bandreject" aria-hidden="true">TOC</a></span></h3>
...
<a name="bass"></a>
<h3 class="section">25.23 bass<span class="pull-right"><a class="anchor hidden-xs" href="#bass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bass" aria-hidden="true">TOC</a></span></h3>
...
<a name="biquad"></a>
<h3 class="section">25.24 biquad<span class="pull-right"><a class="anchor hidden-xs" href="#biquad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-biquad" aria-hidden="true">TOC</a></span></h3>
...
<a name="bs2b"></a>
<h3 class="section">25.25 bs2b<span class="pull-right"><a class="anchor hidden-xs" href="#bs2b" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bs2b" aria-hidden="true">TOC</a></span></h3>
...
<a name="channelmap"></a>
<h3 class="section">25.26 channelmap<span class="pull-right"><a class="anchor hidden-xs" href="#channelmap" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-channelmap" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">25.27 channelsplit<span class="pull-right"><a class="anchor hidden-xs" href="#channelsplit" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-channelsplit" aria-hidden="true">TOC</a></span></h3>
...
<a name="compand"></a>
<h3 class="section">25.28 compand<span class="pull-right"><a class="anchor hidden-xs" href="#compand" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-compand" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.28.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-21" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-21" aria-hidden="true">TOC</a></span></h4>
...
<a name="dcshift"></a>
<h3 class="section">25.29 dcshift<span class="pull-right"><a class="anchor hidden-xs" href="#dcshift" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dcshift" aria-hidden="true">TOC</a></span></h3>
...
<a name="earwax"></a>
<h3 class="section">25.30 earwax<span class="pull-right"><a class="anchor hidden-xs" href="#earwax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-earwax" aria-hidden="true">TOC</a></span></h3>
...
<a name="equalizer"></a>
<h3 class="section">25.31 equalizer<span class="pull-right"><a class="anchor hidden-xs" href="#equalizer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-equalizer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.31.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-22" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-22" aria-hidden="true">TOC</a></span></h4>
<ul>
...
<a name="flanger"></a>
<h3 class="section">25.32 flanger<span class="pull-right"><a class="anchor hidden-xs" href="#flanger" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-flanger" aria-hidden="true">TOC</a></span></h3>
...
<a name="highpass"></a>
<h3 class="section">25.33 highpass<span class="pull-right"><a class="anchor hidden-xs" href="#highpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-highpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="join"></a>
<h3 class="section">25.34 join<span class="pull-right"><a class="anchor hidden-xs" href="#join" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-join" aria-hidden="true">TOC</a></span></h3>
...
<a name="ladspa"></a>
<h3 class="section">25.35 ladspa<span class="pull-right"><a class="anchor hidden-xs" href="#ladspa" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ladspa" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.35.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-23" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-23" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands"></a>
<h4 class="subsection">25.35.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands" aria-hidden="true">TOC</a></span></h4>
...
<a name="lowpass"></a>
<h3 class="section">25.36 lowpass<span class="pull-right"><a class="anchor hidden-xs" href="#lowpass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lowpass" aria-hidden="true">TOC</a></span></h3>
...
<a name="pan"></a>
<h3 class="section">25.37 pan<span class="pull-right"><a class="anchor hidden-xs" href="#pan" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pan" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.37.1 Mixing examples<span class="pull-right"><a class="anchor hidden-xs" href="#Mixing-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Mixing-examples" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">25.37.2 Remapping examples<span class="pull-right"><a class="anchor hidden-xs" href="#Remapping-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Remapping-examples" aria-hidden="true">TOC</a></span></h4>
...
<a name="replaygain"></a>
<h3 class="section">25.38 replaygain<span class="pull-right"><a class="anchor hidden-xs" href="#replaygain" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-replaygain" aria-hidden="true">TOC</a></span></h3>
...
<a name="resample"></a>
<h3 class="section">25.39 resample<span class="pull-right"><a class="anchor hidden-xs" href="#resample" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-resample" aria-hidden="true">TOC</a></span></h3>

<p>Convert the audio sample format, sample rate and channel layout. It is
not meant to be used directly.
</p>
<a name="silencedetect"></a>
<h3 class="section">25.40 silencedetect<span class="pull-right"><a class="anchor hidden-xs" href="#silencedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-silencedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.40.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-24" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-24" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">25.41 silenceremove<span class="pull-right"><a class="anchor hidden-xs" href="#silenceremove" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-silenceremove" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.41.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-25" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-25" aria-hidden="true">TOC</a></span></h4>
...
<a name="treble"></a>
<h3 class="section">25.42 treble<span class="pull-right"><a class="anchor hidden-xs" href="#treble" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-treble" aria-hidden="true">TOC</a></span></h3>
...
<a name="volume"></a>
<h3 class="section">25.43 volume<span class="pull-right"><a class="anchor hidden-xs" href="#volume" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-volume" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-1"></a>
<h4 class="subsection">25.43.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-1" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">25.43.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-26" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-26" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">25.44 volumedetect<span class="pull-right"><a class="anchor hidden-xs" href="#volumedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-volumedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">25.44.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-27" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-27" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">26 Audio Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available audio sources.
</p>
<a name="abuffer"></a>
<h3 class="section">26.1 abuffer<span class="pull-right"><a class="anchor hidden-xs" href="#abuffer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-abuffer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">26.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-28" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-28" aria-hidden="true">TOC</a></span></h4>
...
<a name="aevalsrc"></a>
<h3 class="section">26.2 aevalsrc<span class="pull-right"><a class="anchor hidden-xs" href="#aevalsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-aevalsrc" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">26.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-29" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-29" aria-hidden="true">TOC</a></span></h4>
...
<a name="anullsrc"></a>
<h3 class="section">26.3 anullsrc<span class="pull-right"><a class="anchor hidden-xs" href="#anullsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anullsrc" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">26.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-30" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-30" aria-hidden="true">TOC</a></span></h4>
...
<a name="flite"></a>
<h3 class="section">26.4 flite<span class="pull-right"><a class="anchor hidden-xs" href="#flite" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-flite" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">26.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-31" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-31" aria-hidden="true">TOC</a></span></h4>
...
<a name="sine"></a>
<h3 class="section">26.5 sine<span class="pull-right"><a class="anchor hidden-xs" href="#sine" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sine" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">26.5.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-32" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-32" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">27 Audio Sinks<span class="pull-right"><a class="anchor hidden-xs" href="#Audio-Sinks" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Audio-Sinks" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available audio sinks.
</p>
<a name="abuffersink"></a>
<h3 class="section">27.1 abuffersink<span class="pull-right"><a class="anchor hidden-xs" href="#abuffersink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-abuffersink" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">27.2 anullsink<span class="pull-right"><a class="anchor hidden-xs" href="#anullsink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-anullsink" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">28 Video Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Filters" aria-hidden="true">TOC</a></span></h2>
...
<h3 class="section">28.1 alphaextract<span class="pull-right"><a class="anchor hidden-xs" href="#alphaextract" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-alphaextract" aria-hidden="true">TOC</a></span></h3>
...
<a name="alphamerge"></a>
<h3 class="section">28.2 alphamerge<span class="pull-right"><a class="anchor hidden-xs" href="#alphamerge" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-alphamerge" aria-hidden="true">TOC</a></span></h3>
...
<a name="ass"></a>
<h3 class="section">28.3 ass<span class="pull-right"><a class="anchor hidden-xs" href="#ass" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ass" aria-hidden="true">TOC</a></span></h3>
...
<a name="bbox"></a>
<h3 class="section">28.4 bbox<span class="pull-right"><a class="anchor hidden-xs" href="#bbox" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-bbox" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.5 blackdetect<span class="pull-right"><a class="anchor hidden-xs" href="#blackdetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blackdetect" aria-hidden="true">TOC</a></span></h3>
...
<a name="blackframe"></a>
<h3 class="section">28.6 blackframe<span class="pull-right"><a class="anchor hidden-xs" href="#blackframe" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blackframe" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.7 blend, tblend<span class="pull-right"><a class="anchor hidden-xs" href="#blend_002c-tblend" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-blend_002c-tblend" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.7.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-33" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-33" aria-hidden="true">TOC</a></span></h4>
...
<a name="boxblur"></a>
<h3 class="section">28.8 boxblur<span class="pull-right"><a class="anchor hidden-xs" href="#boxblur" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-boxblur" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.8.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-34" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-34" aria-hidden="true">TOC</a></span></h4>
...
<a name="codecview"></a>
<h3 class="section">28.9 codecview<span class="pull-right"><a class="anchor hidden-xs" href="#codecview" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-codecview" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.9.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-35" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-35" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.10 colorbalance<span class="pull-right"><a class="anchor hidden-xs" href="#colorbalance" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorbalance" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-36" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-36" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.11 colorlevels<span class="pull-right"><a class="anchor hidden-xs" href="#colorlevels" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorlevels" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.11.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-37" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-37" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.12 colorchannelmixer<span class="pull-right"><a class="anchor hidden-xs" href="#colorchannelmixer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colorchannelmixer" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-38" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-38" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.13 colormatrix<span class="pull-right"><a class="anchor hidden-xs" href="#colormatrix" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-colormatrix" aria-hidden="true">TOC</a></span></h3>
...
<a name="copy"></a>
<h3 class="section">28.14 copy<span class="pull-right"><a class="anchor hidden-xs" href="#copy" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-copy" aria-hidden="true">TOC</a></span></h3>

<p>Copy the input source unchanged to the output. This is mainly useful for
testing purposes.
</p>
<a name="crop"></a>
<h3 class="section">28.15 crop<span class="pull-right"><a class="anchor hidden-xs" href="#crop" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-crop" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.15.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-39" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-39" aria-hidden="true">TOC</a></span></h4>
...
<a name="cropdetect"></a>
<h3 class="section">28.16 cropdetect<span class="pull-right"><a class="anchor hidden-xs" href="#cropdetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-cropdetect" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.17 curves<span class="pull-right"><a class="anchor hidden-xs" href="#curves-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-curves-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.17.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-40" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-40" aria-hidden="true">TOC</a></span></h4>
...
<a name="dctdnoiz"></a>
<h3 class="section">28.18 dctdnoiz<span class="pull-right"><a class="anchor hidden-xs" href="#dctdnoiz" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dctdnoiz" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.18.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-41" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-41" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.19 decimate<span class="pull-right"><a class="anchor hidden-xs" href="#decimate-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-decimate-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="dejudder"></a>
<h3 class="section">28.20 dejudder<span class="pull-right"><a class="anchor hidden-xs" href="#dejudder" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dejudder" aria-hidden="true">TOC</a></span></h3>
...
<a name="delogo"></a>
<h3 class="section">28.21 delogo<span class="pull-right"><a class="anchor hidden-xs" href="#delogo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-delogo" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.21.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-42" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-42" aria-hidden="true">TOC</a></span></h4>
...
<a name="deshake"></a>
<h3 class="section">28.22 deshake<span class="pull-right"><a class="anchor hidden-xs" href="#deshake" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-deshake" aria-hidden="true">TOC</a></span></h3>
...
<a name="drawbox"></a>
<h3 class="section">28.23 drawbox<span class="pull-right"><a class="anchor hidden-xs" href="#drawbox" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawbox" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.23.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-43" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-43" aria-hidden="true">TOC</a></span></h4>
...
<a name="drawgrid"></a>
<h3 class="section">28.24 drawgrid<span class="pull-right"><a class="anchor hidden-xs" href="#drawgrid" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawgrid" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.24.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-44" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-44" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.25 drawtext<span class="pull-right"><a class="anchor hidden-xs" href="#drawtext-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-drawtext-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Syntax-2"></a>
<h4 class="subsection">28.25.1 Syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Syntax-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Syntax-2" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.25.2 Text expansion<span class="pull-right"><a class="anchor hidden-xs" href="#Text-expansion" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Text-expansion" aria-hidden="true">TOC</a></span></h4>
...
The second argument specifies the output format. Allowed values are &rsquo;x&rsquo;, &rsquo;X&rsquo;, &rsquo;d&rsquo; and
&rsquo;u&rsquo;. They are treated exactly as in the printf function.
...
<h4 class="subsection">28.25.3 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-45" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-45" aria-hidden="true">TOC</a></span></h4>
...
<a name="edgedetect"></a>
<h3 class="section">28.26 edgedetect<span class="pull-right"><a class="anchor hidden-xs" href="#edgedetect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-edgedetect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.26.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-46" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-46" aria-hidden="true">TOC</a></span></h4>
...
<a name="eq"></a>
<h3 class="section">28.27 eq<span class="pull-right"><a class="anchor hidden-xs" href="#eq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-eq" aria-hidden="true">TOC</a></span></h3>
...
<dl compact="compact">
<dt><samp>contrast</samp></dt>
<dd><p>Set the contrast value. It accepts a float value in range <code>-2.0</code> to
<code>2.0</code>. The default value is <code>0.0</code>.
</p>
</dd>
<dt><samp>brightness</samp></dt>
<dd><p>Set the brightness value. It accepts a float value in range <code>-1.0</code> to
<code>1.0</code>. The default value is <code>0.0</code>.
</p>
</dd>
<dt><samp>saturation</samp></dt>
<dd><p>Set the saturation value. It accepts a float value in range <code>0.0</code> to
<code>3.0</code>. The default value is <code>1.0</code>.
</p>
</dd>
<dt><samp>gamma</samp></dt>
<dd><p>Set the gamma value. It accepts a float value in range <code>0.1</code> to <code>10.0</code>.
The default value is <code>1.0</code>.
</p>
</dd>
<dt><samp>gamma_r</samp></dt>
<dd><p>Set the gamma value for red. It accepts a float value in range
<code>0.1</code> to <code>10.0</code>. The default value is <code>1.0</code>.
</p>
</dd>
<dt><samp>gamma_g</samp></dt>
<dd><p>Set the gamma value for green. It accepts a float value in range
<code>0.1</code> to <code>10.0</code>. The default value is <code>1.0</code>.
</p>
</dd>
<dt><samp>gamma_b</samp></dt>
<dd><p>Set the gamma value for blue. It accepts a float value in range
<code>0.1</code> to <code>10.0</code>. The default value is <code>1.0</code>.
</p>
</dd>
<dt><samp>gamma_weight</samp></dt>
<dd><p>Can be used to reduce the effect of a high gamma value on bright image areas,
e.g. keep them from getting overamplified and just plain white. It accepts a
float value in range <code>0.0</code> to <code>1.0</code>.A value of <code>0.0</code> turns the
gamma correction all the way down while <code>1.0</code> leaves it at its full strength.
...
<a name="Commands-2"></a>
<h4 class="subsection">28.27.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-2" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-2" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.28 extractplanes<span class="pull-right"><a class="anchor hidden-xs" href="#extractplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-extractplanes" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.28.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-47" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-47" aria-hidden="true">TOC</a></span></h4>
...
<a name="elbg"></a>
<h3 class="section">28.29 elbg<span class="pull-right"><a class="anchor hidden-xs" href="#elbg" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-elbg" aria-hidden="true">TOC</a></span></h3>
...
<a name="fade"></a>
<h3 class="section">28.30 fade<span class="pull-right"><a class="anchor hidden-xs" href="#fade" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fade" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.30.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-48" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-48" aria-hidden="true">TOC</a></span></h4>
...
<a name="fftfilt"></a>
<h3 class="section">28.31 fftfilt<span class="pull-right"><a class="anchor hidden-xs" href="#fftfilt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fftfilt" aria-hidden="true">TOC</a></span></h3>
...
<a name="field"></a>
<h3 class="section">28.32 field<span class="pull-right"><a class="anchor hidden-xs" href="#field" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-field" aria-hidden="true">TOC</a></span></h3>
...
<a name="fieldmatch"></a>
<h3 class="section">28.33 fieldmatch<span class="pull-right"><a class="anchor hidden-xs" href="#fieldmatch" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fieldmatch" aria-hidden="true">TOC</a></span></h3>
...
Do not use <code>fieldmatch</code> and <a href="#decimate">decimate</a> if your input has mixed
...
<h4 class="subsection">28.33.1 p/c/n/u/b meaning<span class="pull-right"><a class="anchor hidden-xs" href="#p_002fc_002fn_002fu_002fb-meaning-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-p_002fc_002fn_002fu_002fb-meaning-1" aria-hidden="true">TOC</a></span></h4>

<a name="p_002fc_002fn"></a>
<h4 class="subsubsection">28.33.1.1 p/c/n<span class="pull-right"><a class="anchor hidden-xs" href="#p_002fc_002fn" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-p_002fc_002fn" aria-hidden="true">TOC</a></span></h4>
...
<a name="u_002fb"></a>
<h4 class="subsubsection">28.33.1.2 u/b<span class="pull-right"><a class="anchor hidden-xs" href="#u_002fb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-u_002fb" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.33.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-49" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-49" aria-hidden="true">TOC</a></span></h4>
...
<a name="fieldorder"></a>
<h3 class="section">28.34 fieldorder<span class="pull-right"><a class="anchor hidden-xs" href="#fieldorder" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fieldorder" aria-hidden="true">TOC</a></span></h3>
...
<a name="fifo"></a>
<h3 class="section">28.35 fifo<span class="pull-right"><a class="anchor hidden-xs" href="#fifo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fifo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.36 format<span class="pull-right"><a class="anchor hidden-xs" href="#format-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-format-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.36.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-50" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-50" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.37 fps<span class="pull-right"><a class="anchor hidden-xs" href="#fps-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fps-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.37.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-51" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-51" aria-hidden="true">TOC</a></span></h4>
...
<a name="framepack"></a>
<h3 class="section">28.38 framepack<span class="pull-right"><a class="anchor hidden-xs" href="#framepack" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-framepack" aria-hidden="true">TOC</a></span></h3>
...
<a name="framestep"></a>
<h3 class="section">28.39 framestep<span class="pull-right"><a class="anchor hidden-xs" href="#framestep" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-framestep" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.40 frei0r<span class="pull-right"><a class="anchor hidden-xs" href="#frei0r-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-frei0r-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.40.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-52" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-52" aria-hidden="true">TOC</a></span></h4>
...
<a name="fspp"></a>
<h3 class="section">28.41 fspp<span class="pull-right"><a class="anchor hidden-xs" href="#fspp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-fspp" aria-hidden="true">TOC</a></span></h3>
...
<a name="geq"></a>
<h3 class="section">28.42 geq<span class="pull-right"><a class="anchor hidden-xs" href="#geq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-geq" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.42.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-53" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-53" aria-hidden="true">TOC</a></span></h4>
...
<a name="gradfun"></a>
<h3 class="section">28.43 gradfun<span class="pull-right"><a class="anchor hidden-xs" href="#gradfun" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-gradfun" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.43.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-54" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-54" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.44 haldclut<span class="pull-right"><a class="anchor hidden-xs" href="#haldclut-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-haldclut-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.44.1 Workflow examples<span class="pull-right"><a class="anchor hidden-xs" href="#Workflow-examples" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Workflow-examples" aria-hidden="true">TOC</a></span></h4>

<a name="Hald-CLUT-video-stream"></a>
<h4 class="subsubsection">28.44.1.1 Hald CLUT video stream<span class="pull-right"><a class="anchor hidden-xs" href="#Hald-CLUT-video-stream" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Hald-CLUT-video-stream" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsubsection">28.44.1.2 Hald CLUT with preview<span class="pull-right"><a class="anchor hidden-xs" href="#Hald-CLUT-with-preview" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Hald-CLUT-with-preview" aria-hidden="true">TOC</a></span></h4>
...
<a name="hflip"></a>
<h3 class="section">28.45 hflip<span class="pull-right"><a class="anchor hidden-xs" href="#hflip" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hflip" aria-hidden="true">TOC</a></span></h3>
...
<a name="histeq"></a>
<h3 class="section">28.46 histeq<span class="pull-right"><a class="anchor hidden-xs" href="#histeq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-histeq" aria-hidden="true">TOC</a></span></h3>
...
<a name="histogram"></a>
<h3 class="section">28.47 histogram<span class="pull-right"><a class="anchor hidden-xs" href="#histogram" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-histogram" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.47.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-55" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-55" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.48 hqdn3d<span class="pull-right"><a class="anchor hidden-xs" href="#hqdn3d-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hqdn3d-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="hqx"></a>
<h3 class="section">28.49 hqx<span class="pull-right"><a class="anchor hidden-xs" href="#hqx" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hqx" aria-hidden="true">TOC</a></span></h3>
...
<a name="hue"></a>
<h3 class="section">28.50 hue<span class="pull-right"><a class="anchor hidden-xs" href="#hue" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-hue" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.50.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-56" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-56" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands-3"></a>
<h4 class="subsection">28.50.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-3" aria-hidden="true">TOC</a></span></h4>
...
<a name="idet"></a>
<h3 class="section">28.51 idet<span class="pull-right"><a class="anchor hidden-xs" href="#idet" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-idet" aria-hidden="true">TOC</a></span></h3>
...
statistics is halved (i.e., it contributes only 0.5 to it&rsquo;s
...
<a name="il"></a>
<h3 class="section">28.52 il<span class="pull-right"><a class="anchor hidden-xs" href="#il" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-il" aria-hidden="true">TOC</a></span></h3>
...
<a name="interlace"></a>
<h3 class="section">28.53 interlace<span class="pull-right"><a class="anchor hidden-xs" href="#interlace" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-interlace" aria-hidden="true">TOC</a></span></h3>
...
<a name="kerndeint"></a>
<h3 class="section">28.54 kerndeint<span class="pull-right"><a class="anchor hidden-xs" href="#kerndeint" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-kerndeint" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.54.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-57" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-57" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.55 lenscorrection<span class="pull-right"><a class="anchor hidden-xs" href="#lenscorrection" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lenscorrection" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-17"></a>
<h4 class="subsection">28.55.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-17" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-17" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.56 lut3d<span class="pull-right"><a class="anchor hidden-xs" href="#lut3d-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lut3d-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.57 lut, lutrgb, lutyuv<span class="pull-right"><a class="anchor hidden-xs" href="#lut_002c-lutrgb_002c-lutyuv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-lut_002c-lutrgb_002c-lutyuv" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.57.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-58" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-58" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.58 mergeplanes<span class="pull-right"><a class="anchor hidden-xs" href="#mergeplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mergeplanes" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.58.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-59" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-59" aria-hidden="true">TOC</a></span></h4>
...
<a name="mcdeint"></a>
<h3 class="section">28.59 mcdeint<span class="pull-right"><a class="anchor hidden-xs" href="#mcdeint" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mcdeint" aria-hidden="true">TOC</a></span></h3>
...
<a name="mpdecimate"></a>
<h3 class="section">28.60 mpdecimate<span class="pull-right"><a class="anchor hidden-xs" href="#mpdecimate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mpdecimate" aria-hidden="true">TOC</a></span></h3>
...
<a name="negate"></a>
<h3 class="section">28.61 negate<span class="pull-right"><a class="anchor hidden-xs" href="#negate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-negate" aria-hidden="true">TOC</a></span></h3>
...
<a name="noformat"></a>
<h3 class="section">28.62 noformat<span class="pull-right"><a class="anchor hidden-xs" href="#noformat" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-noformat" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.62.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-60" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-60" aria-hidden="true">TOC</a></span></h4>
...
<a name="noise-1"></a>
<h3 class="section">28.63 noise<span class="pull-right"><a class="anchor hidden-xs" href="#noise-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-noise-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.63.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-61" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-61" aria-hidden="true">TOC</a></span></h4>
...
<a name="null"></a>
<h3 class="section">28.64 null<span class="pull-right"><a class="anchor hidden-xs" href="#null" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-null" aria-hidden="true">TOC</a></span></h3>

<p>Pass the video source unchanged to the output.
</p>
<a name="ocv"></a>
<h3 class="section">28.65 ocv<span class="pull-right"><a class="anchor hidden-xs" href="#ocv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ocv" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.65.1 dilate<span class="pull-right"><a class="anchor hidden-xs" href="#dilate-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-dilate-1" aria-hidden="true">TOC</a></span></h4>
...
<a name="erode"></a>
<h4 class="subsection">28.65.2 erode<span class="pull-right"><a class="anchor hidden-xs" href="#erode" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-erode" aria-hidden="true">TOC</a></span></h4>
...
<a name="smooth"></a>
<h4 class="subsection">28.65.3 smooth<span class="pull-right"><a class="anchor hidden-xs" href="#smooth" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-smooth" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.66 overlay<span class="pull-right"><a class="anchor hidden-xs" href="#overlay-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-overlay-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-4"></a>
<h4 class="subsection">28.66.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-4" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-4" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.66.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-62" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-62" aria-hidden="true">TOC</a></span></h4>
...
<a name="owdenoise"></a>
<h3 class="section">28.67 owdenoise<span class="pull-right"><a class="anchor hidden-xs" href="#owdenoise" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-owdenoise" aria-hidden="true">TOC</a></span></h3>
...
<a name="pad"></a>
<h3 class="section">28.68 pad<span class="pull-right"><a class="anchor hidden-xs" href="#pad" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pad" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.68.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-63" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-63" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.69 palettegen<span class="pull-right"><a class="anchor hidden-xs" href="#palettegen-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-palettegen-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.69.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-64" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-64" aria-hidden="true">TOC</a></span></h4>
...
<a name="paletteuse"></a>
<h3 class="section">28.70 paletteuse<span class="pull-right"><a class="anchor hidden-xs" href="#paletteuse" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-paletteuse" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.70.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-65" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-65" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.71 perspective<span class="pull-right"><a class="anchor hidden-xs" href="#perspective" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-perspective" aria-hidden="true">TOC</a></span></h3>
...
<a name="phase"></a>
<h3 class="section">28.72 phase<span class="pull-right"><a class="anchor hidden-xs" href="#phase" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-phase" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.73 pixdesctest<span class="pull-right"><a class="anchor hidden-xs" href="#pixdesctest" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pixdesctest" aria-hidden="true">TOC</a></span></h3>
...
<a name="pp"></a>
<h3 class="section">28.74 pp<span class="pull-right"><a class="anchor hidden-xs" href="#pp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pp" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.74.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-66" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-66" aria-hidden="true">TOC</a></span></h4>
...
<a name="pp7"></a>
<h3 class="section">28.75 pp7<span class="pull-right"><a class="anchor hidden-xs" href="#pp7" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pp7" aria-hidden="true">TOC</a></span></h3>
...
<a name="psnr"></a>
<h3 class="section">28.76 psnr<span class="pull-right"><a class="anchor hidden-xs" href="#psnr" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-psnr" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.77 pullup<span class="pull-right"><a class="anchor hidden-xs" href="#pullup-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-pullup-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="qp"></a>
<h3 class="section">28.78 qp<span class="pull-right"><a class="anchor hidden-xs" href="#qp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-qp" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.78.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-67" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-67" aria-hidden="true">TOC</a></span></h4>
...
<a name="removelogo"></a>
<h3 class="section">28.79 removelogo<span class="pull-right"><a class="anchor hidden-xs" href="#removelogo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-removelogo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.80 repeatfields<span class="pull-right"><a class="anchor hidden-xs" href="#repeatfields" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-repeatfields" aria-hidden="true">TOC</a></span></h3>

<p>This filter uses the repeat_field flag from the Video ES headers and hard repeats
fields based on its value.
</p>
<a name="rotate"></a>
<h3 class="section">28.81 rotate<span class="pull-right"><a class="anchor hidden-xs" href="#rotate" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-rotate" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.81.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-68" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-68" aria-hidden="true">TOC</a></span></h4>
...
<a name="Commands-5"></a>
<h4 class="subsection">28.81.2 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-5" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-5" aria-hidden="true">TOC</a></span></h4>
...
<a name="sab"></a>
<h3 class="section">28.82 sab<span class="pull-right"><a class="anchor hidden-xs" href="#sab" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sab" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.83 scale<span class="pull-right"><a class="anchor hidden-xs" href="#scale-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-scale-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-18"></a>
<h4 class="subsection">28.83.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-18" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-18" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.83.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-69" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-69" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.84 separatefields<span class="pull-right"><a class="anchor hidden-xs" href="#separatefields" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-separatefields" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.85 setdar, setsar<span class="pull-right"><a class="anchor hidden-xs" href="#setdar_002c-setsar" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setdar_002c-setsar" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.85.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-70" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-70" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.86 setfield<span class="pull-right"><a class="anchor hidden-xs" href="#setfield-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setfield-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="showinfo"></a>
<h3 class="section">28.87 showinfo<span class="pull-right"><a class="anchor hidden-xs" href="#showinfo" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showinfo" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.88 showpalette<span class="pull-right"><a class="anchor hidden-xs" href="#showpalette" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showpalette" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.89 shuffleplanes<span class="pull-right"><a class="anchor hidden-xs" href="#shuffleplanes" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-shuffleplanes" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.90 signalstats<span class="pull-right"><a class="anchor hidden-xs" href="#signalstats" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-signalstats" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.90.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-71" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-71" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.91 smartblur<span class="pull-right"><a class="anchor hidden-xs" href="#smartblur-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-smartblur-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="stereo3d"></a>
<h3 class="section">28.92 stereo3d<span class="pull-right"><a class="anchor hidden-xs" href="#stereo3d" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-stereo3d" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.92.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-72" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-72" aria-hidden="true">TOC</a></span></h4>
...
</li><li> Convert input video from above bellow (left eye above, right eye below) to side by side crosseye.
<div class="example">
...
<h3 class="section">28.93 spp<span class="pull-right"><a class="anchor hidden-xs" href="#spp-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-spp-1" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.94 subtitles<span class="pull-right"><a class="anchor hidden-xs" href="#subtitles-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-subtitles-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="super2xsai"></a>
<h3 class="section">28.95 super2xsai<span class="pull-right"><a class="anchor hidden-xs" href="#super2xsai" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-super2xsai" aria-hidden="true">TOC</a></span></h3>
...
<a name="swapuv"></a>
<h3 class="section">28.96 swapuv<span class="pull-right"><a class="anchor hidden-xs" href="#swapuv" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-swapuv" aria-hidden="true">TOC</a></span></h3>
<p>Swap U &amp; V plane.
</p>
<a name="telecine"></a>
<h3 class="section">28.97 telecine<span class="pull-right"><a class="anchor hidden-xs" href="#telecine" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-telecine" aria-hidden="true">TOC</a></span></h3>
...
<a name="thumbnail"></a>
<h3 class="section">28.98 thumbnail<span class="pull-right"><a class="anchor hidden-xs" href="#thumbnail" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-thumbnail" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.98.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-73" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-73" aria-hidden="true">TOC</a></span></h4>
...
<a name="tile"></a>
<h3 class="section">28.99 tile<span class="pull-right"><a class="anchor hidden-xs" href="#tile" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tile" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.99.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-74" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-74" aria-hidden="true">TOC</a></span></h4>
...
<a name="tinterlace"></a>
<h3 class="section">28.100 tinterlace<span class="pull-right"><a class="anchor hidden-xs" href="#tinterlace" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-tinterlace" aria-hidden="true">TOC</a></span></h3>
...
<a name="transpose"></a>
<h3 class="section">28.101 transpose<span class="pull-right"><a class="anchor hidden-xs" href="#transpose" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-transpose" aria-hidden="true">TOC</a></span></h3>
...
<a name="trim"></a>
<h3 class="section">28.102 trim<span class="pull-right"><a class="anchor hidden-xs" href="#trim" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-trim" aria-hidden="true">TOC</a></span></h3>
<p>Trim the input so that the output contains one continuous subpart of the input.
</p>
<p>It accepts the following parameters:
</p><dl compact="compact">
...
<h3 class="section">28.103 unsharp<span class="pull-right"><a class="anchor hidden-xs" href="#unsharp-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-unsharp-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.103.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-75" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-75" aria-hidden="true">TOC</a></span></h4>
...
<a name="uspp"></a>
<h3 class="section">28.104 uspp<span class="pull-right"><a class="anchor hidden-xs" href="#uspp" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-uspp" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.105 vidstabdetect<span class="pull-right"><a class="anchor hidden-xs" href="#vidstabdetect-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vidstabdetect-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.105.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-76" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-76" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">28.106 vidstabtransform<span class="pull-right"><a class="anchor hidden-xs" href="#vidstabtransform-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vidstabtransform-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="Options-19"></a>
<h4 class="subsection">28.106.1 Options<span class="pull-right"><a class="anchor hidden-xs" href="#Options-19" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Options-19" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.106.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-77" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-77" aria-hidden="true">TOC</a></span></h4>
...
<a name="vflip"></a>
<h3 class="section">28.107 vflip<span class="pull-right"><a class="anchor hidden-xs" href="#vflip" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vflip" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.108 vignette<span class="pull-right"><a class="anchor hidden-xs" href="#vignette-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-vignette-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.108.1 Expressions<span class="pull-right"><a class="anchor hidden-xs" href="#Expressions" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Expressions" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">28.108.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-78" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-78" aria-hidden="true">TOC</a></span></h4>
...
<a name="w3fdif"></a>
<h3 class="section">28.109 w3fdif<span class="pull-right"><a class="anchor hidden-xs" href="#w3fdif" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-w3fdif" aria-hidden="true">TOC</a></span></h3>
...
<a name="xbr"></a>
<h3 class="section">28.110 xbr<span class="pull-right"><a class="anchor hidden-xs" href="#xbr" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-xbr" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">28.111 yadif<span class="pull-right"><a class="anchor hidden-xs" href="#yadif-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-yadif-1" aria-hidden="true">TOC</a></span></h3>
...
<a name="zoompan"></a>
<h3 class="section">28.112 zoompan<span class="pull-right"><a class="anchor hidden-xs" href="#zoompan" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-zoompan" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">28.112.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-79" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-79" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">29 Video Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available video sources.
</p>
<a name="buffer"></a>
<h3 class="section">29.1 buffer<span class="pull-right"><a class="anchor hidden-xs" href="#buffer" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-buffer" aria-hidden="true">TOC</a></span></h3>
...
<a name="cellauto"></a>
<h3 class="section">29.2 cellauto<span class="pull-right"><a class="anchor hidden-xs" href="#cellauto" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-cellauto" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">29.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-80" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-80" aria-hidden="true">TOC</a></span></h4>
...
<a name="mandelbrot"></a>
<h3 class="section">29.3 mandelbrot<span class="pull-right"><a class="anchor hidden-xs" href="#mandelbrot" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mandelbrot" aria-hidden="true">TOC</a></span></h3>
...
<a name="mptestsrc"></a>
<h3 class="section">29.4 mptestsrc<span class="pull-right"><a class="anchor hidden-xs" href="#mptestsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-mptestsrc" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">29.5 frei0r_src<span class="pull-right"><a class="anchor hidden-xs" href="#frei0r_005fsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-frei0r_005fsrc" aria-hidden="true">TOC</a></span></h3>
...
<a name="life"></a>
<h3 class="section">29.6 life<span class="pull-right"><a class="anchor hidden-xs" href="#life" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-life" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">29.6.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-81" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-81" aria-hidden="true">TOC</a></span></h4>
...
<a name="color"></a><a name="haldclutsrc"></a><a name="nullsrc"></a><a name="rgbtestsrc"></a><a name="smptebars"></a><a name="smptehdbars"></a><a name="testsrc"></a><a name="color_002c-haldclutsrc_002c-nullsrc_002c-rgbtestsrc_002c-smptebars_002c-smptehdbars_002c-testsrc"></a>
<h3 class="section">29.7 color, haldclutsrc, nullsrc, rgbtestsrc, smptebars, smptehdbars, testsrc<span class="pull-right"><a class="anchor hidden-xs" href="#color_002c-haldclutsrc_002c-nullsrc_002c-rgbtestsrc_002c-smptebars_002c-smptehdbars_002c-testsrc" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-color_002c-haldclutsrc_002c-nullsrc_002c-rgbtestsrc_002c-smptebars_002c-smptehdbars_002c-testsrc" aria-hidden="true">TOC</a></span></h3>
...
<a name="Commands-6"></a>
<h4 class="subsection">29.7.1 Commands<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-6" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-6" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">30 Video Sinks<span class="pull-right"><a class="anchor hidden-xs" href="#Video-Sinks" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Video-Sinks" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available video sinks.
</p>
<a name="buffersink"></a>
<h3 class="section">30.1 buffersink<span class="pull-right"><a class="anchor hidden-xs" href="#buffersink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-buffersink" aria-hidden="true">TOC</a></span></h3>
...
<a name="nullsink"></a>
<h3 class="section">30.2 nullsink<span class="pull-right"><a class="anchor hidden-xs" href="#nullsink" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-nullsink" aria-hidden="true">TOC</a></span></h3>
...
<h2 class="chapter">31 Multimedia Filters<span class="pull-right"><a class="anchor hidden-xs" href="#Multimedia-Filters" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Multimedia-Filters" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available multimedia filters.
</p>
<a name="avectorscope"></a>
<h3 class="section">31.1 avectorscope<span class="pull-right"><a class="anchor hidden-xs" href="#avectorscope" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-avectorscope" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.1.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-82" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-82" aria-hidden="true">TOC</a></span></h4>
...
<a name="concat-3"></a>
<h3 class="section">31.2 concat<span class="pull-right"><a class="anchor hidden-xs" href="#concat-3" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-concat-3" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-83" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-83" aria-hidden="true">TOC</a></span></h4>
...
<a name="ebur128"></a>
<h3 class="section">31.3 ebur128<span class="pull-right"><a class="anchor hidden-xs" href="#ebur128" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-ebur128" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.3.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-84" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-84" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.4 interleave, ainterleave<span class="pull-right"><a class="anchor hidden-xs" href="#interleave_002c-ainterleave" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-interleave_002c-ainterleave" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.4.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-85" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-85" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.5 perms, aperms<span class="pull-right"><a class="anchor hidden-xs" href="#perms_002c-aperms" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-perms_002c-aperms" aria-hidden="true">TOC</a></span></h3>
...
<h3 class="section">31.6 select, aselect<span class="pull-right"><a class="anchor hidden-xs" href="#select_002c-aselect" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-select_002c-aselect" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.6.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-86" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-86" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.7 sendcmd, asendcmd<span class="pull-right"><a class="anchor hidden-xs" href="#sendcmd_002c-asendcmd" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-sendcmd_002c-asendcmd" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.7.1 Commands syntax<span class="pull-right"><a class="anchor hidden-xs" href="#Commands-syntax" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Commands-syntax" aria-hidden="true">TOC</a></span></h4>
...
<h4 class="subsection">31.7.2 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-87" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-87" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.8 setpts, asetpts<span class="pull-right"><a class="anchor hidden-xs" href="#setpts_002c-asetpts" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-setpts_002c-asetpts" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.8.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-88" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-88" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.9 settb, asettb<span class="pull-right"><a class="anchor hidden-xs" href="#settb_002c-asettb" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-settb_002c-asettb" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.9.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-89" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-89" aria-hidden="true">TOC</a></span></h4>
...
<a name="showcqt"></a>
<h3 class="section">31.10 showcqt<span class="pull-right"><a class="anchor hidden-xs" href="#showcqt" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showcqt" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.10.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-90" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-90" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.11 showspectrum<span class="pull-right"><a class="anchor hidden-xs" href="#showspectrum" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showspectrum" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.11.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-91" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-91" aria-hidden="true">TOC</a></span></h4>
...
<a name="showwaves"></a>
<h3 class="section">31.12 showwaves<span class="pull-right"><a class="anchor hidden-xs" href="#showwaves" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-showwaves" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.12.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-92" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-92" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.13 split, asplit<span class="pull-right"><a class="anchor hidden-xs" href="#split_002c-asplit" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-split_002c-asplit" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.13.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-93" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-93" aria-hidden="true">TOC</a></span></h4>
...
<h3 class="section">31.14 zmq, azmq<span class="pull-right"><a class="anchor hidden-xs" href="#zmq_002c-azmq" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-zmq_002c-azmq" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">31.14.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-94" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-94" aria-hidden="true">TOC</a></span></h4>
...
<h2 class="chapter">32 Multimedia Sources<span class="pull-right"><a class="anchor hidden-xs" href="#Multimedia-Sources" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Multimedia-Sources" aria-hidden="true">TOC</a></span></h2>

<p>Below is a description of the currently available multimedia sources.
</p>
<a name="amovie"></a>
<h3 class="section">32.1 amovie<span class="pull-right"><a class="anchor hidden-xs" href="#amovie" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-amovie" aria-hidden="true">TOC</a></span></h3>

<p>This is the same as <a href="#movie">movie</a> source, except it selects an audio
stream by default.
</p>
<a name="movie"></a><a name="movie-1"></a>
<h3 class="section">32.2 movie<span class="pull-right"><a class="anchor hidden-xs" href="#movie-1" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-movie-1" aria-hidden="true">TOC</a></span></h3>
...
<h4 class="subsection">32.2.1 Examples<span class="pull-right"><a class="anchor hidden-xs" href="#Examples-95" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Examples-95" aria-hidden="true">TOC</a></span></h4>
...
<a name="See-Also"></a>
<h2 class="chapter">33 See Also<span class="pull-right"><a class="anchor hidden-xs" href="#See-Also" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-See-Also" aria-hidden="true">TOC</a></span></h2>
...
<a name="Authors"></a>
<h2 class="chapter">34 Authors<span class="pull-right"><a class="anchor hidden-xs" href="#Authors" aria-hidden="true">#</a> <a class="anchor hidden-xs"href="#toc-Authors" aria-hidden="true">TOC</a></span></h2>
